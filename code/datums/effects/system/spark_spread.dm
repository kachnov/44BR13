...
///effects/system/spark_spread/Del()
	//pool(src)
	//no no no no no stop doing this what the fuck man aaaaaaaa -singh
	
/effects/system/spark_spread/pooled()
...
/effects/system/spark_spread/proc/set_up(n = 3, c = 0, loca)
	if (n > 10)
		n = 10
	number = n
	cardinals = c
...
/effects/system/spark_spread/proc/attach(atom/atom)
	holder = atom
	
/effects/system/spark_spread/proc/detach()
	holder = null
	
/effects/system/spark_spread/proc/update()
...
/effects/system/spark_spread/proc/start()
