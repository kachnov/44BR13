/trader/buford
	...
	base_goods_buy = list(/commodity/trader/buford/vennecure,
	/commodity/trader/buford/megaweed,
	/commodity/trader/buford/whiteweed,
	/commodity/trader/buford/omegaweed,
	/commodity/trader/buford/psilocybin,
	/commodity/trader/buford/pizza)// 6

	base_goods_sell = list(/commodity/trader/buford/alienseeds,
	/commodity/trader/buford/weedseeds,
	/commodity/trader/buford/powerplant,
	/commodity/trader/buford/mutriant,
	/commodity/trader/buford/groboost,
	/commodity/trader/buford/fruitful,
	/commodity/trader/buford/topcrop,
	/commodity/trader/buford/weedkiller)// 8
	...
	New()
		...
		if (prob(10))
			...
			dialogue_haggle_accept = list("Ahahaha, fuckin' hilarious man.",
			...
			dialogue_wrong_haggle_reject = list("What? Sorry, wasn't listening. Ha ha.")
			...
			dialogue_out_of_stock = list("Oh I ain't got any of that? Where is it? Where'd it go? Huh.")

// Buford is selling these things

/commodity/trader/buford/alienseeds
...
/commodity/trader/buford/weedkiller
	comname = "Weedkiller"
...
/commodity/trader/buford/vennecure
