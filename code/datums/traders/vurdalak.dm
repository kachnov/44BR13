/trader/vurdalak
	...
	base_goods_buy = list(/commodity/trader/vurdalak/meat,
	/commodity/trader/vurdalak/brains,
	/commodity/trader/vurdalak/deathweed,
	/commodity/trader/vurdalak/toxicvenne,
	/commodity/trader/vurdalak/amanita,
	/commodity/trader/vurdalak/roburger)
	base_goods_sell = list(/commodity/trader/vurdalak/artifact)
	...
	set_up_goods()
		..()
		var/commodity/the_commodity = null
		var/pickwhich = rand(1,3)
		switch(pickwhich)
			if (1)
				the_commodity = /commodity/trader/vurdalak/obsidiancrown
			if (2)
				the_commodity = /commodity/trader/vurdalak/ancientarmor
			if (3)
				the_commodity = /commodity/trader/vurdalak/relic
		var/commodity/COM = new the_commodity(src)
		goods_buy += COM

// Vurdalak is selling these things

/commodity/trader/vurdalak/artifact
...
/commodity/trader/vurdalak/meat
	comname = "Raw Meat"
...
/commodity/trader/vurdalak/obsidiancrown
...
/commodity/trader/vurdalak/ancientarmor
...
/commodity/trader/vurdalak/relic
