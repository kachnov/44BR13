/trader/pianzi_hundan
	...
	base_goods_buy = list(/commodity/trader/pianzi/herbs,
	/commodity/trader/pianzi/crystalglass,
	/commodity/trader/pianzi/telecrystal,
	/commodity/trader/pianzi/artifact,
	/commodity/trader/pianzi/cigarettes)
	base_goods_sell = list(/commodity/trader/pianzi/metal,
	/commodity/trader/pianzi/bees,
	/commodity/trader/pianzi/cameraviewers,
	/commodity/trader/pianzi/scanners,
	/commodity/trader/pianzi/concgloves,
	/commodity/trader/pianzi/medicine,
	/commodity/trader/pianzi/wine,
	/commodity/trader/pianzi/recdrugs,
	/commodity/trader/pianzi/seeds)
