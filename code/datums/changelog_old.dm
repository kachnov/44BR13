...
(t)sat nov 16 13
(u)Dr. Singh
(*)WASD mode now has two new keys! Press <strong>Q</strong> to drop and press <strong>G</strong> to set the focus to the input box to start entering a command without having to click in that narrow box or turn off WASD mode.
...
(t)mon sep 02 13
(u)Dr. Singh
(*)<strong>WASD MODE</strong>, gosh! Press Tab to toggle. E is switch hands, C is use item, X is toggle throw, Z is end run. T to talk.
...
(*)<strong>YOU NEED TO RE-SET UP YOUR JOB PREFERENCES FOR EACH CHARACTER YOU HAVE! GO INTO THE WINDOW AND HIT RESET! THEN SAVE IT!!!</strong>
(-)
(t)mon may 27 13
(u)Infinite Monkeys
...
(t)tue mar 27 12
(u)Procitizen
(*)<strong>New Thing</strong>: Shard Recycler in the bar! It can turn glass shards into cups and plates!!!
(*)<strong>Sorta New Things</strong>: Shot and wine glasses, can be made with the Shard Recycler (see it's not useless)
...
(t)mon mar 05 12
(u)I Said No
(*)<strong>Bugfix:</strong> Corruption should now be applied to a whole area rather than patches.
(*)<strong>Bugfix:</strong> Corruption should no longer be affected by light levels.
(*)<strong>Bugfix:</strong> Wizards should no longer temporarily spawn naked on the Arrival Shuttle.
(*)<strong>Bugfix:</strong> The end of the round should now correctly state whether the ritual was a failure or success.
(*)<strong>Change:</strong> Corruption Ritual now completes more quickly.
(*)<strong>Change:</strong> The Corruption objective now needs 40% of the station corrupted, down from 50%.
(*)<strong>Change:</strong> Clairovoyance's cooldown was lengthened from 10 seconds to one minute.
(*)<strong>Addition:</strong> A Magic Mirror in the Wizard's Station. Wizards that examine it will be told all objectives that need to be completed.
(*)<strong>Please report any persisting or new bugs! Thank you!</strong>
(-)
(t)sun mar 04 12
(u)I Said No
...
(t)sat jul 09 11
(u)Procitizen
(*)<strong>New Job:</strong> Head Surgeon, King of Medbay
...
(t)tue jan 18 11
(u)sniperchance
(*)<strong><em><font color="red">Janitor gets a new toy!!</font></strong></em> - A ridable floor buffer that you can load with different chemicals.
(-)
(u)I Said No
...
(*)<strong>ATTENTION STATION SECURITY</strong>: The following is a message from SecuTech security. <em>Thank you for trying SecuTech Virtual-Reality (VSPACE) Prisoner Containment Unit™. We hope you enjoyed your trial, but your evaluation copy has expired. Please register and purchase SecuTech Virtual-Reality (VSPACE) Prisoner Containment Unit™ to continue. Thank you and have a secure day. (NT vbrig will keep on keepin on)</em>
(-)
(t)sun dec 19 10
(u)I Said No
