/targetable/werewolf/werewolf_transform
	name = "Transform"
	...
	cast(mob/target)
		...
		actions.start(new/action/bar/private/icon/werewolf_transform(src), M)
		return FALSE

/action/bar/private/icon/werewolf_transform
	duration = 50
	interrupt_flags = INTERRUPT_MOVE | INTERRUPT_ACT | INTERRUPT_ACTION
	id = "werewolf_transform"
	icon = 'icons/mob/screen1.dmi'
	icon_state = "grabbed"
	var/targetable/werewolf/werewolf_transform/transform
	...
	onStart()
		...
		boutput(M, __red("<strong>You feel a strong burning sensation all over your body!</strong>"))
