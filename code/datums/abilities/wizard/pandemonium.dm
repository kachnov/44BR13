...
/mob/living/carbon/human/proc/PAND_Fireburst(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> radiates a wave of burning heat!</span>", src), 1)
...
/mob/living/carbon/human/proc/PAND_Babel(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> emits a faint smell of cheese!</span>", src), 1)
...
/mob/living/carbon/human/proc/PAND_Tripballs(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> radiates a confusing aura!</span>", src), 1)
...
/mob/living/carbon/human/proc/PAND_Flashbang(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> explodes into a brilliant flash of light!</span>", src), 1)
...
/mob/living/carbon/human/proc/PAND_Meteors(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> summons meteors!</span>", src), 1)
	for (var/turf/T in orange(1, src))
		if (!T.density)
			var/target_dir = get_dir(loc, T)
...
/mob/living/carbon/human/proc/PAND_Screech(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> emits a horrible shriek!</span>", src), 1)
	playsound(loc, "sound/effects/screech.ogg", 25, 1, -1)
...
/mob/living/carbon/human/proc/PAND_Boost(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> glows with magical power!</span>", src), 1)
	playsound(loc, "sound/mksounds/boost.ogg", 25, 1, -1)
	bioHolder.AddEffect("arcane_power", timeleft = 60)

/mob/living/carbon/human/proc/PAND_Roar(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> emits a horrific reverberating roar!</span>", src), 1)
...
/mob/living/carbon/human/proc/PAND_Signaljam(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> emits a wave of electrical interference!</span>", src), 1)
	playsound(loc, "sound/effects/mag_warp.ogg", 25, 1, -1)
	for (var/mob/living/carbon/human/M in mobs)
...
/mob/living/carbon/human/proc/PAND_Grilles(var/protectuser = 1)
	for (var/mob/O in AIviewers(src, null)) O.show_message(text("<span style=\"color:red\"><strong>[]</strong> reshapes the metal around \him!</span>", src), 1)
	playsound(loc, "sound/effects/grillehit.ogg", 25, 1, -1)
