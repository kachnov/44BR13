/targetable/spell/cluwne
	...
	cast(mob/target)
		...
		if (H.mind && (H.mind.assigned_role != "Cluwne") || (!H.mind || !H.client))
			boutput(H, "<span style=\"color:red\"><strong>You HONK painfully!</strong></span>")
			H.take_brain_damage(80)
			H.stuttering = 120
			if (H.mind)
				H.mind.assigned_role = "Cluwne"
			H.contract_disease(/ailment/disability/clumsy,null,null,1)
			H.contract_disease(/ailment/disease/cluwneing_around,null,null,1)
