/puzzlewizard/spawnloc
	...
	initialize()
		var/adventure_submode/critter/adv = new() // instantiating for statics grghhgh.
		...
		qdel(adv)
		boutput(usr, "<span style=\"color:blue\">Left click to create a critter spawn location. Right click to set critter initial data in all <em>subsequent</em> critter spawners. Ctrl+click to proceed.</span>")
...
/obj/adventurepuzzle/triggerable/spawnloc
	...
	New()
		..()
		underlays += image('icons/obj/randompuzzles.dmi', "critter_spawn")
