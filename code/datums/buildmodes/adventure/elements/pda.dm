/puzzlewizard/pda
	...
	proc/show_html_help()
		var/help_text = {"<strong>If you don't know what HTML is, you probably should read up on it on w3schools.com.</strong><br><br>
...
<strong>Action slots</strong> are defined by the placeholders in the form of &lt;index&gt;, where index is a number greater than or equal to 1.<br>
