...
***********************************************************"}
	...
	New()
		...
		for (var/smt in subtypesof(/adventure_submode))
			var/adventure_submode/SM = new smt(holder, src)
			submodes += SM.name
			submodes[SM.name] = SM
...
/adventure_submode
	...
	var/buildmode_holder/holder
	var/buildmode/adventure/adventure
...
/obj/screen/buildadventure
	...
	var/buildmode_holder/holder = null
	var/buildmode/adventure/parent = null
