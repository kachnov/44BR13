...
/game_mode/deathmatch
	...
	announce()
		boutput(world, "<strong>The current game mode is - Death Commando Deathmatch!</strong>")
		boutput(world, "<strong>Just kill everyone else. They're gonna try to kill you, after all. Respawning is enabled.</strong>")
