...
/game_mode/ctf/announce()
	boutput(world, "<strong>The current game mode is - Capture the Flag!</strong>")
	boutput(world, "<strong>Capture the other teams flag and bring it back to your base!</strong>")
	boutput(world, "Respawn is on")

/game_mode/ctf/pre_setup()
