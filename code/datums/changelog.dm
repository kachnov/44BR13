...
(t)fri feb 12 16
(u)Haine
(*)<strong>Destiny only</strong>: You can now return to cryosleep in the cryotron, if you have to leave for whatever reason. There's a 15 minute wait before you can leave cryosleep again once you enter. That time may be adjusted in the future.
(t)sat jan 30 16
(u)Haine
...
(t)mon dec 07 15
(u)Haine
(*)<strong>Destiny only</strong>: Security Officers now have access to everywhere but heads' offices and other command locations (bridge/EVA/AI/etc). HoS now have all access plus their armory access. Please don't abuse this so I don't have to remove it again.
(t)tue dec 01 15
(u)Haine
(*)Merry Spacemas!
...
(*)Major credit to <strong>Somepotato</strong> for the original idea and code.
(t)wed jul 08 15
(u)Infinite Monkeys
...
(u)Marquesas
(*)<strong>It's-a me, Marquesas</strong> doing more changes which:
...
(t)mon mar 09 15
(u)Marquesas
(*)In case you're wondering, it's 12:01 AM so it's the 9th in the <em>significant</em> places of the world.
(*)<strong>Update ft. Pacra:</strong> Total telecrystal cost reorganization.
...
(*)<strong>THE ALT EMOTE FOR BIRDWELL IS NO LONGER *flex</strong>.  It's now *burp.  This may or may not have anything to do with the hotkey for *burp being CTRL+B.
...
(*)Finally, but most importantly: Blob has been released. I'm still working on the balance but it shouldn't be <strong>far too biased</strong> in favour of one side.
(t)wed jan 14 15
(u)Haine
...
(*)Implants weren't properly being cut out of people; the implant itself wasn't being relocated, so cutting one out from someone just sorta made an empty case and never actually removed the thing - except from the list of implants in the person, so then you could <strong>never</strong> get it out.
(t)wed dec 10 14
(u)Aphtonites
...
(u)Haine
(*)I'm starting to port things to the new blood/bleeding system.  It's <strong>not enabled</strong> by default yet, but if you see something related to blood acting weirdly, let me know.
(t)sat nov 22 14
(u)SpyGuy
...
(*)Keep it on the DL, you hear?  Don't ask where he got that stuff from.  You don't need to know.  You don't <em>wanna</em> know.  Aight?  Aight.
(t)wed sep 17 14
(u)AngriestIBM
...
(*)Vending machine sprites in the new perspective.  All fifty gajillion of them.  An <strong>immense</strong> thank you to YJHGHTFH for all the work he put into them!
(t)mon sep 01 14
(u)Wire and YJHGHTFH
...
(*)<strong>If you have issues returning to core, hit cancel camera view, this is due to a BYOND bug.</strong>
(-)
(t)thu apr 17 14
(u)Tobba
...
/proc/changelog_parse(var/changes, var/title)
	...
	if (!text)
		...
		html += "<ul class=\"log\"><li class=\"title\"><i class=\"icon-bookmark\"></em> [title] as of [svn_revision]</li>"
		...
		for (var/line in lines)
			...
			switch(copytext(line, 1, 4))
				...
				if ("(u)")
					html += "<li class=\"admin\"><span><i class=\"icon-check\"></em> [copytext(line, 4, 0)]</span> updated:</li>"
				if ("(*)")
