...
/bioEffect/particles
	...
	var/system_path = /particleSystem/sparkles
...
/bioEffect/color_changer
	...
	OnAdd()
		...
		if (!H.bioHolder)
			return
		var/bioHolder/B = H.bioHolder
		if (!B.mobAppearance)
			return
		var/appearanceHolder/AH = H.bioHolder.mobAppearance
