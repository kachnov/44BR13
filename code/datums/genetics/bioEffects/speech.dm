...
/bioEffect/speech/comic
	name = "Frontal Gyrus Alteration Type-CS"
	desc = "Causes the speech center of the subject's brain to become, uh. Well, <em>something</em> happens to it."
	id = "accent_comic"
	effectType = effectTypeDisability
	isBad = 1
...
/bioEffect/speech/unintelligable
...
/bioEffect/speech/reversed_speech
...
/bioEffect/speech/zalgo
	...
	New()
		msgGain = zalgoify(msgGain, 8, 2, 8)
		..()
