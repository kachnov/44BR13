...
/dna_chromosome/power_enhancer
	name = "Power Booster"
	desc = "Makes abilities granted by genes more powerful."

	apply(var/bioEffect/power/BE)
		if (!istype(BE))
...
/dna_chromosome/cooldown_reducer
	name = "Energy Booster"
