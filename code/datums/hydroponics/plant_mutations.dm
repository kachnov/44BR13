/plantmutation/
	...
	proc/HYPharvested_proc_M(var/obj/machinery/plantpot/POT, var/mob/user)
		...
		if (lasterr)
			logTheThing("debug", null, null, "<strong>Plant HYP</strong> [src] in pot [POT] failed with error [.]")
...
/plantmutation/tomato/explosive
...
/plantmutation/eggplant/literal
...
/plantmutation/wheat/steelwheat
	name = "steelwheat"
	iconmod = "steelwheat"
...
/plantmutation/synthmeat/butt/buttbot
	name = "Synthbuttbot"
	iconmod = "butts"
...
/plantmutation/contusine/shivering
	name = "Shivering Contusine"
	iconmod = "shivercon"
	assoc_reagents = list("salbutamol")
	chance = 20

/plantmutation/contusine/quivering
...
/plantmutation/nureous/fuzzy
	name = "Fuzzy Nureous"
	assoc_reagents = list("hairgrownium")

// Asomna Mutations

/plantmutation/asomna/robust
	name = "Robust Asomna"
	iconmod = "AsomnaR"
...
/plantmutation/cannabis/ultimate
	name = "Omega Weed"
	iconmod = "Oweed"
...
/plantmutation/radweed/safeweed
	name = "White Radweed"
	iconmod = "whiterad"
	special_proc_override = 1
	...
	HYPspecial_proc_M(var/obj/machinery/plantpot/POT)
		...
		if (POT.growth > (P.harvtime + DNA.harvtime) && prob(10))
			...
			for (var/obj/machinery/plantpot/C in range(radrange,POT))
				var/plant/growing = C.current
				if (istype(growing,/plant/radweed)) continue
				if (growing) C.HYPmutateplant(radrange * 2)

/plantmutation/radweed/redweed
