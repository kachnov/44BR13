...
(t)tue nov 25 14
(u)Haine
(*)You'll now only see messages when someone's forced into the reclaimer while <strong>alive</strong>.
(t)mon nov 24 14
(u)Haine
...
(u)Haine
(*)Vampire's thralls will also recieve alert popups like mindslaves will now. Kinda redundant considering how long it takes to enthrall someone, but hey, consist<strong>E</strong>ncy. THERE SPY ARE YOU HAPPY THERE'S AN E NOW
(t)sat sep 13 14
(u)Marquesas
