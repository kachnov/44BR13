/random_event/major/blowout
	...
	event_effect()
		...
		world << blowoutsound
		boutput(world, "<span style=\"color:red\"><strong>WARNING</strong>: Mass radiation has struck [station_name()]. Do not leave safety until all radiation alerts have been cleared.</span>")
