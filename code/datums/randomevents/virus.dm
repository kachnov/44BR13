/random_event/major/virus
	...
	event_effect(var/source)
		..()
		var/virus_type = pick(/ailment/disease/flu,/ailment/disease/clowning_around,
		/ailment/disease/berserker,/ailment/disease/space_madness)
