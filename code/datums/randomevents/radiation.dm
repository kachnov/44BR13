/proc/create_radwave(var/turf/pulseloc, var/rads_amt, var/sound/pulse_sound)
	particleMaster.SpawnSystem(new /particleSystem/radevent_warning(pulseloc))
	spawn (30)
		...
		particleMaster.SpawnSystem(new /particleSystem/radevent_pulse(pulseloc))

/random_event/major/radiation
