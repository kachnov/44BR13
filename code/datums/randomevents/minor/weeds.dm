/random_event/minor/weeds
	...
	event_effect()
		...
		switch (rand(1,6))
			...
			if (1) WS.planttype = new /plant/fungus(target_plant_pot)
			if (2) WS.planttype = new /plant/lasher(target_plant_pot)
			if (3) WS.planttype = new /plant/creeper(target_plant_pot)
			if (4) WS.planttype = new /plant/radweed(target_plant_pot)
			if (5) WS.planttype = new /plant/slurrypod(target_plant_pot)
			if (6) WS.planttype = new /plant/grass(target_plant_pot)
