...
/updateQueue
	...
	var/tmp/updateQueueWorker/currentWorker
	var/tmp/workerTimeout
	var/tmp/adjustedWorkerTimeout
	var/tmp/currentKillCount
	var/tmp/totalKillCount
	
/updateQueue/New(list/objects = list(), procName = "update", list/arguments = list(), workerTimeout = 2, inplace = 0)
	..()
 ...
 * @param bool inplace whether the updateQueue should make a copy of objects.
					   ...
					   copy.
 */
/updateQueue/proc/init(list/objects = list(), procName = "update", list/arguments = list(), workerTimeout = 2, inplace = 0)
...
/updateQueue/proc/initList(list/toCopy)
	/**
