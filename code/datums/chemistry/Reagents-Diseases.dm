...
/reagent
	...
	disease/rainbow_fluid // Clowning Around
		...
		fluid_b = 255
		transparency = 0
		disease = /ailment/disease/clowning_around
	...
	disease/vampire_serum
		...
		fluid_b = 0
		transparency = 255
		disease = /ailment/disease/vampiritis
	...
	disease/painbow_fluid // CLUWNE VIRUS
		...
		fluid_b = 255
		transparency = 0
		disease = /ailment/disease/cluwneing_around
	...
	disease/lycanthropy //Please never give this an actual recipe .I
		...
		fluid_b = 133
		transparency = 0
		disease = /ailment/disease/lycanthropy
	...
	disease/stringy_gibbis // Fake GBS
		...
		fluid_b = 0
		transparency = 60
		disease = /ailment/disease/fake_gbs
	...
	disease/banana_peel // Jungle Fever
		...
		fluid_b = 0
		transparency = 150
		disease = /ailment/disease/jungle_fever
	...
	disease/liquid_plasma // Plasmatoid
		...
		fluid_b = 200
		transparency = 80
		disease = /ailment/disease/plasmatoid
		//on_mob_life(var/mob/M)
	...
	disease/nanites // Robot Transformation
		...
		fluid_b = 101
		transparency = 110
		disease = /ailment/disease/robotic_transformation
		//on_mob_life(var/mob/M)
	...
	disease/liquid_spacetime // Teleportitis
		...
		fluid_b = 0
		transparency = 60
		disease = /ailment/disease/teleportitis
	...
	disease/pubbie_tears // Berserker
		...
		fluid_b = 255
		transparency = 30
		disease = /ailment/disease/berserker
	...
	disease/salmonella // Food Poisoning
		...
		fluid_b = 0
		transparency = 255
		disease = /ailment/disease/food_poisoning
	...
	disease/MRSA // for infected wounds
		...
		fluid_b = 0
		transparency = 255
		disease = /ailment/disease/infection
	...
	disease/necrovirus // Necrotic Degeneration
		...
		fluid_b = 200
		transparency = 170
		disease = /ailment/disease/necrotic_degeneration
	...
	disease/viral_curative // Panacaea
		...
		fluid_b = 255
		transparency = 10
		disease = /ailment/disease/panacaea
	...
	disease/rotting // Tissue Necrosis
		...
		transparency = 10
		penetrates_skin = 1
		disease = /ailment/disease/tissue_necrosis
	...
	disease/HIV // Space AIDS
		...
		fluid_b = 40
		transparency = 50
		disease = /ailment/disease/space_aids
	...
	disease/loose_screws // Space Madness
		...
		fluid_b = 70
		transparency = 70
		disease = /ailment/disease/space_madness
	...
	disease/grave_dust // Vampire Plague
		...
		fluid_b = 70
		transparency = 255
		disease = /ailment/disease/vamplague
	...
	disease/spidereggs // oh god
		...
		fluid_b = 255
		transparency = 0
		disease = /ailment/parasite/spidereggs
	...
	disease/bee
		...
		disease = /ailment/parasite/bee_larva
	...
	disease/concentrated_initro // please do not give a recipe, just a thing for testing heart-related things atm
		...
		fluid_b = 232
		transparency = 0
		disease = /ailment/disease/flatline
	...
	disease/bacon_grease // please do not give a recipe, just a thing for testing heart-related things atm
		...
		fluid_b = 177
		transparency = 0
		disease = /ailment/disease/heartfailure
	...
	disease/heartworms // please do not give a recipe, just a thing for testing heart-related things atm
		...
		fluid_b = 108
		transparency = 0
		disease = /ailment/disease/noheart
