...
About the Holder:
	...
	currently in the object.It also has all the procs needed to manipulate reagents
		...
		trans_to_direct(var/reagents/target_reagents, var/amount=1, var/multiplier=1)
...
About the Tools:
	...
	system you'll need to add something like this in its new proc:
		...
		var/reagents/R = new/reagents(100) <<<<< create a new datum , 100 is the maximum_volume of the new holder datum.
