/ailment/disease/edisons_disease
	...
	proc
		cause_blindness(var/mob/living/affected_mob)
			affected_mob.contract_disease(/ailment/disability/blind, null, null, 1)
...
/ailment/disease/edisons_disease/on_infection(var/mob/living/affected_mob,var/ailment_data/D)
	boutput(affected_mob, "<span style=\"color:red\">Your eyes feel strange...</span>")

/ailment/disease/edisons_disease/stage_act(var/mob/living/affected_mob,var/ailment_data/D)
	if (..())
		return
		...
		if (D.stage < 3)
			...
			if (prob(50))
				...
				for (var/mob/O in viewers(affected_mob, null))
					O.show_message(text("<span style=\"color:red\"><strong>[]</strong> starts convulsing violently!</span>", affected_mob), 1)
