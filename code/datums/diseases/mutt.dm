...
// surgery
/ailment/parasite/mutt/surgery(var/mob/living/surgeon, var/mob/living/affected_mob, var/ailment_data/D)
	if (D.disposed)
		return FALSE
	var/outcome = rand(90)
...
/ailment/parasite/mutt/stage_act(var/mob/living/affected_mob,var/ailment_data/parasite/D)
	if (..())
		return
	...
	switch(D.stage)
		...
		if (4)
			var/mob/living/carbon/human/xenomorph/X = affected_mob
			X.spawn_mutt()
