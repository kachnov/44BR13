...
/ailment/disease/shock/stage_act(var/mob/living/affected_mob,var/ailment_data/D)
	if (..())
		return
	...
	switch(D.stage)
		...
		if (3)
			...
			if (prob(5))
				affected_mob.contract_disease(/ailment/disease/heartfailure,null,null,1)