...
/ailment/disease/cluwneing_around
...
/ailment/disease/cluwneing_around/stage_act(var/mob/living/affected_mob,var/ailment_data/D)
	if (..())
		return
...
/*
/ailment/disease/cluwneing_around/disposing()
	if (affected_mob)
		if (oldname && oldjob)
			affected_mob.real_name = oldname
			affected_mob.job = oldjob
