...
/ailment/disease/vamplague/stage_act(var/mob/living/affected_mob,var/ailment_data/D)
	if (..())
		return
...
/ailment/disease/vampiritis
	...
	stage_act(var/mob/living/affected_mob,var/ailment_data/D)
		if (..())
			return
