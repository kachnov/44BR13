...
/projectile/laser/light // for the drones
	name = "phaser bolt"
	...
	split
		...
		on_launch(var/obj/projectile/P)
			if (!P)
				return
			var/projectile/laser/light/L = new()
			L.power = 40
			var/turf/PT = get_turf(P)
			var/obj/projectile/P1 = initialize_projectile(PT, L, P.xo, P.yo, P.shooter)
			P1.launch()
	...
	upgradeable
		...
		var/projectile/laser/light/launched = new/projectile/laser/light
		var/count = 1
...
/projectile/laser/glitter // for the russian pod
...
/projectile/laser/precursor // for precursor traps
	name = "energy bolt"
	icon_state = "disrupt"
	power = 30
	cost = 30
...
/projectile/laser/pred //mostly just a reskin
	icon_state = "phaser_med"
	name = "plasma bolt"
	sname = "plasma bolt"
