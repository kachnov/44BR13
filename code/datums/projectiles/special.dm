...
/projectile/special/shock_orb/always_mob
	tick(var/obj/projectile/P)
		var/list/smobs = list()
...
/projectile/special/volatile_goo
	name = "Volatile Goo"
	icon_state = "ice"
	power = 1
	dissipation_rate = 1
