/ailment/disability/clumsy
	name = "Dyspraxia"
	max_stages = 1
	cure = "Unknown"
	affected_species = list("Human")

/ailment/disability/clumsy/stage_act(var/mob/living/affected_mob,var/ailment_data/D)
	if (..())
		return
	...
	if (prob(6))
		...
		M.hand = h
	if (prob(3))
		M.visible_message("<span style=\"color:red\"><strong>[M.name]</strong> stumbles and falls!</span>")
