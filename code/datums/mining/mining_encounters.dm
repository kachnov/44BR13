...
/mining_encounter/asteroid_small
	name = "Small Asteroid"
	rarity_tier = -1
...
/proc/Turfspawn_Wreckage(var/turf/space/center,var/size = 6,var/area/area_restriction = null)
	...
	var/material/scrap_material = null
