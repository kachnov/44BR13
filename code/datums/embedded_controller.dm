...
/computer/file/embedded_program/access_controller
	var/id_tag
...
/computer/file/embedded_program/airlock_controller
	var/id_tag
	var/exterior_door_tag
	var/interior_door_tag
	var/airpump_tag
...
/computer/file/embedded_program/department_controller
	var/id_tag
	var/door_tag
...
/obj/machinery/embedded_controller
	var/computer/file/embedded_program/program
	...
	proc/post_signal(signal/signal, comm_line)
		return FALSE
...
/obj/machinery/embedded_controller/radio/access_controller
	...
	initialize()
		...
		var/computer/file/embedded_program/access_controller/new_prog = new
...
<A href='?src=\ref[src];command=cycle_closed'>Lock Exterior Airlock</A><BR>"}
		...
		var/output = {"<strong>Access Control Console</strong><HR>
[state_options]<HR>
<strong>Exterior Door: </strong> [exterior_status]<BR>
<strong>Interior Door: </strong> [interior_status]<BR>"}
...
/obj/machinery/embedded_controller/radio/airlock_controller
	...
	initialize()
		...
		var/computer/file/embedded_program/airlock_controller/new_prog = new
...
<A href='?src=\ref[src];command=cycle_closed'>Close Exterior Airlock</A><BR>"}
		...
		var/output = {"<strong>Airlock Control Console</strong><HR>
[state_options]<HR>
<strong>Chamber Pressure:</strong> [sensor_pressure] kPa<BR>
<strong>Exterior Door: </strong> [exterior_status]<BR>
<strong>Interior Door: </strong> [interior_status]<BR>
<strong>Control Pump: </strong> [pump_status]<BR>"}
...
/obj/machinery/embedded_controller/radio/department_controller
	...
	initialize()
		...
		var/computer/file/embedded_program/department_controller/new_prog = new
	...
	attackby(var/obj/item/I as obj, mob/user as mob)
		...
		if (istype(I, /obj/item/card/id))
			if (allowed(user, req_only_one_required))
				user.visible_message("[user] [locked ? "unlocks" : "locks"] the access panel.","You [locked ? "unlock" : "lock"] the access panel.")
				locked = !locked
			else
	...
	attack_hand(mob/user)
		...
		var/output = "<strong>Department Airlock Control Console</strong><HR>"
		if (locked && !issilicon(user))
			output += "<center><strong>Console Locked</strong><br><em>Please swipe ID</em></center>"
		else
			output += "[state_options]<hr><strong>Airlock Status: </strong> [door_status]"
