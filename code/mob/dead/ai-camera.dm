...
/mob/living/intangible/aicamera/proc/adjustView()
	...
	client.images.Remove(prev_imgs)
	prev_imgs.Cut()
	...
	if ((loc.opacity || opaque) && !sidesVisible(src, covered))
...
/mob/living/intangible/aicamera/Life(controller/process/mobs/parent)
	..(parent)
	adjustView()
