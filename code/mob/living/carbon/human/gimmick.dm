...
/mob/living/carbon/human/cluwne
	New()
		...
		spawn (0)
			gender = "male"
			real_name = "cluwne"
			contract_disease(/ailment/disease/cluwneing_around,null,null,1)
			contract_disease(/ailment/disability/clumsy,null,null,1)

			equip_if_possible(new /obj/item/clothing/under/gimmick/cursedclown(src), slot_w_uniform)
			equip_if_possible(new /obj/item/clothing/shoes/cursedclown_shoes(src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/mask/cursedclown_hat(src), slot_wear_mask)
			equip_if_possible(new /obj/item/clothing/gloves/cursedclown_gloves(src), slot_gloves)
			make_jittery(1000)
			bioHolder.AddEffect("clumsy")
			take_brain_damage(80)
...
/mob/living/carbon/human/fatherted
	New()
		...
		spawn (0)
			...
			real_name = "Father Ted"

			equip_if_possible(new /obj/item/clothing/shoes/red(src), slot_shoes)

			equip_if_possible(new /obj/item/clothing/under/rank/chaplain(src), slot_w_uniform)
...
/mob/living/carbon/human/fatherjack
	...
	Life(controller/process/mobs/parent)
		...
		if (prob(1) && !stat)
			spawn (0) say(pick( "DRINK!", "FECK!", "ARSE!", "GIRLS!","That would be an ecumenical matter."))
...
/mob/living/carbon/human/biker
	...
	New()
		...
		spawn (0)
			...
			equip_if_possible(new /obj/item/clothing/shoes/brown(src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/under/misc/head_of_security(src), slot_w_uniform)
			//equip_if_possible(new /obj/item/clothing/suit(src), slot_wear_suit)
			//equip_if_possible(new /obj/item/clothing/head/biker_cap(src), slot_head)
	...
	Life(controller/process/mobs/parent)
		...
		if (!stat)
			if (target)
				...
				if (get_dist(src, target) <= 1 && !LinkBlocked(loc, target.loc))
...
/mob/living/carbon/human/merchant
	New()
		...
		spawn (0)
			gender = "male"
			real_name = pick("Slick", "Fast", "Frugal", "Thrifty", "Clever", "Shifty") + " " + pick(first_names_male)
			equip_if_possible(new /obj/item/clothing/shoes/black(src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/under/gimmick/merchant(src), slot_w_uniform)
			equip_if_possible(new /obj/item/clothing/suit/merchant(src), slot_wear_suit)
			equip_if_possible(new /obj/item/clothing/glasses/sunglasses(src), slot_glasses)
			equip_if_possible(new /obj/item/clothing/head/merchant_hat(src), slot_head)
...
/mob/living/carbon/human/myke
	New()
		...
		spawn (0)
			...
			equip_if_possible(new /obj/item/clothing/under/color/lightred(src), slot_w_uniform)

			equip_if_possible(new /obj/item/clothing/mask/breath(src), slot_wear_mask)
			internal = back
	Life(controller/process/mobs/parent)
		if (..(parent))
			return TRUE
...
/mob/living/carbon/human/waldo
	New()
		...
		spawn (0)
			...
			equip_if_possible(new /obj/item/clothing/shoes/brown(src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/under/gimmick/waldo(src), slot_w_uniform)
			equip_if_possible(new /obj/item/clothing/head/waldohat(src), slot_head)
...
/mob/living/carbon/human/fake_waldo
	...
	New()
		...
		spawn (0)
			gender = "male"
			bioHolder.mobAppearance.s_tone = pick(0, -140, -50)
			real_name = "[pick(prob(150); "W", "V")][pick(prob(150); "a", "au", "o", "e")][pick(prob(150); "l", "ll")][pick(prob(150); "d", "t")][pick(prob(150); "o", "oh", "a", "e")]"

			spawn (10)
				bioHolder.mobAppearance.UpdateMob()

			var/shoes = text2path("/obj/item/clothing/shoes/" + pick("black","brown","red"))
			equip_if_possible(new shoes(src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/under/gimmick/fake_waldo(src), slot_w_uniform)
			equip_if_possible(new /obj/item/device/radio/headset(src), slot_ears)
			equip_if_possible(new /obj/item/storage/backpack(src), slot_back)
			if (prob(75))
				equip_if_possible(new /obj/item/clothing/head/fake_waldohat(src), slot_head)
			else if (prob(20))
				equip_if_possible(new /obj/item/clothing/glasses/sunglasses(src), slot_glasses)
	...
	proc/illusion_expire(mob/user)
		if (user)
			boutput(user, "<span style=\"color:red\"><strong>You reach out to attack the Waldo illusion but it explodes into dust, knocking you off your feet!</strong></span>")
			user.weakened = max(user.weakened, 4)
		for (var/mob/M in viewers(src, null))
			if (M.client && M != user)
				M.show_message("<span style=\"color:red\"><strong>The Waldo illusion explodes into smoke!</strong></span>")
...
/mob/living/carbon/human/don_glab
	...
	New()
		...
		spawn (0)
			...
			equip_if_possible(new /obj/item/clothing/shoes/orange(src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/under/suit/red(src), slot_w_uniform)
			equip_if_possible(new /obj/item/clothing/glasses/sunglasses, slot_glasses)
			equip_if_possible(new /obj/item/clothing/head/cowboy(src), slot_head)
...
/mob/living/carbon/human/tommy
	...
	New()
		...
		spawn (0)
			...
			equip_if_possible(new /obj/item/clothing/shoes/black {cant_drop = 1; cant_other_remove = 1; cant_self_remove = 1} (src), slot_shoes)
			equip_if_possible(new /obj/item/clothing/under/suit {cant_drop = 1; cant_other_remove = 1; cant_self_remove = 1} (src), slot_w_uniform)

			equip_if_possible(new /obj/item/device/radio/headset(src), slot_ears)
			equip_if_possible(new /obj/item/storage/backpack(src), slot_back)
			equip_if_possible(new /obj/item/football(src), slot_in_backpack)
