...
/obj/stationMapObj
	...
	MouseUp(var/location,var/control,var/params)
		...
		if (paramList.Find("left"))
			...
			boutput(usr, "<span style=\"color:blue\">That is <strong>[clicked.loc.name]</strong>.</span>")
/*			boutput(usr, "<span style=\"color:green\"><em>[clicked.loc.desc]</em></span>") // none of these fucking things have descriptions anyway
