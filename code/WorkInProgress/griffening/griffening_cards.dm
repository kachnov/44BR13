...
/playing_card/griffening
	proc/enter_play(var/griffening_controller/field_data, var/active_player)
	proc/card_activated(var/griffening_controller/field_data, var/playing_card/griffening/C, var/owner)
	proc/card_destroyed(var/griffening_controller/field_data, var/playing_card/griffening/C, var/owner)
	proc/begin_turn(var/griffening_controller/field_data, var/active_player)
	proc/end_turn(var/griffening_controller/field_data, var/active_player)
	proc/exit_play(var/griffening_controller/field_data, var/active_player)

	// Called during own turn, to check if a card can be played.
	proc/can_play(var/griffening_controller/field_data, var/face_up, var/active_player)
		return TRUE

	proc/before_play(var/griffening_controller/field_data, var/face_up, var/active_player, var/mob/M)
		return TRUE

	proc/can_respond(var/griffening_controller/field_data, var/playing_card/griffening/triggering_card, var/action, var/active_player)
		return FALSE
	...
	creature
		...
		mob
			captain
				...
				can_play(var/griffening_controller/field_data, var/face_up, var/active_player)
					if (field_data.player_has_card(/playing_card/griffening/creature/mob/nukeop, active_player))
						return FALSE
					if (field_data.player_has_card_face_up(type) || field_data.opponent_has_card_face_up(type))
						return FALSE
					var/playing_card/griffening/area/A = field_data.get_face_up_area_card()
					if (!istype(A, /playing_card/griffening/area/bridge))
						return FALSE
					return TRUE

				enter_play(var/griffening_controller/field_data, var/active_player)
					field_data.retrieve_card_type_from_player_deck(/playing_card/griffening/effect/energy_gun, active_player, 0)
	...
	effect
		...
		bolts
			...
			can_respond(var/griffening_controller/field_data, var/playing_card/griffening/triggering_card, var/action, var/active_player)
				if (istype(triggering_card, /playing_card/griffening/area))
					return TRUE
				return FALSE
