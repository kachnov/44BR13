/construction_controller
	...
	var/construction_event/current_event = null
	var/construction_event/next_event = null
	var/construction_event/fallback_event = null
	...
	New()
		for (var/evtype in typesof(/construction_event))
			var/construction_event/E = new evtype()
			if (E.is_abstract)
				qdel(E)
			else
				all_events += E
	...
	proc/notify_milestone_complete(var/progress/P)
		for (var/construction_event/E in all_events)
			if (istype(P, E.milestone))
				possible_events += E
		rebuild_event_types()

	proc/notify_milestone_uncomplete(var/progress/P)
		for (var/construction_event/E in possible_events)
			if (istype(P, E.milestone))
				possible_events -= E
		rebuild_event_types()
...
/construction_event/siege/rockworm
	name = "Siege?"
...
/construction_event/siege/martian
	name = "Martian Siege"
...
/construction_event/siege/spirits
	name = "Spirit Siege"
...
/construction_event/siege/animals
	name = "Animal Siege"
...
/construction_event/siege/plants
	name = "Plant Siege"
...
/construction_event/siege/drones
	name = "Drone Siege"
	event_type = "Syndicate Siege"
...
/construction_event/siege/drones_buzz
	name = "Buzz Drone Siege"
	event_type = "Syndicate Siege"
	warning_text = "We are under siege from a small drone force!"
	attacker_types = list(/obj/critter/gunbot/drone/buzzdrone)
	bosses = list(/obj/critter/gunbot/drone/buzzdrone)
	milestone = /progress/pods/tier1
	original_size = 6
	original_bosses = 1
	is_abstract = 0
	method = METHOD_EDGE_WANDER

/construction_event/siege/drones_heavy
	name = "Heavy Drone Siege"
	event_type = "Syndicate Siege"
	warning_text = "We are under siege from a small drone force!"
	attacker_types = list(/obj/critter/gunbot/drone/buzzdrone)
	bosses = list(/obj/critter/gunbot/drone/heavydrone)
	milestone = /progress/pods/tier2
	original_size = 6
	original_bosses = 1
	is_abstract = 0
	method = METHOD_EDGE_WANDER

/construction_event/meteors
...
/construction_event/meteors/small_meteor_storm
...
/construction_event/meteors/medium_meteor_storm
	name = "Medium Meteor Shower"
	milestone = /progress/time/twohours
...
/construction_event/meteors/massive_meteor_storm
	name = "Large Meteor Shower"
	milestone = /progress/time/sixhours
...
/construction_event/radiation_storm
...
/proc/trigger_specific_construction_event()
	...
	var/game_mode/construction/C = ticker.mode
	var/construction_controller/E = C.events
	var/construction_event/EV = input("Which event", "Event", null) in E.all_events
	E.event_delay = 1
	E.process()
