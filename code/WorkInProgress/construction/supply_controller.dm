...
/demand_control/artifacts
	...
	New()
		..()
		comhandheld = new /commodity/smallartifact()
		comlarge = new /commodity/largeartifact()
...
/demand_control/produce
	commodities = list(/commodity/produce)
...
/demand_control/herbs
	commodities = list(/commodity/herbs)
	high_demand_level = 20
	static_growth = 10
	current_demand_level = 20
...
/demand_control/gold
	commodities = list(/commodity/goldbar)
	high_demand_level = 8
	static_growth = 0
...
/demand_control/goldnuggets
	commodities = list(/commodity/ore/gold)
	high_demand_level = 20
	static_growth = 0
	current_demand_level = 20
...
/demand_control/common_ores
	commodities = list(/commodity/ore/mauxite, /commodity/ore/pharosium, /commodity/ore/molitz, /commodity/ore/char)
...
/demand_control/common_valuables
	commodities = list(/commodity/ore/cobryl)
	high_demand_level = 50
	static_growth = 5
	current_demand_level = 20
	maximum_demand_level = 100

/demand_control/alien_ores
	commodities = list(/commodity/ore/koshmarite, /commodity/ore/viscerite)
	high_demand_level = 250
	static_growth = 10
	current_demand_level = 250
	maximum_demand_level = 300

/demand_control/rare_ores
	commodities = list(/commodity/ore/claretine, /commodity/ore/bohrum)
	high_demand_level = 100
	static_growth = 20
	current_demand_level = 100
	maximum_demand_level = 500

/demand_control/special_ores
	commodities = list(/commodity/ore/cerenkite, /commodity/ore/plasmastone)
	high_demand_level = 10
	static_growth = 2
	current_demand_level = 0
	maximum_demand_level = 100

/demand_control/rare_valuables
	commodities = list(/commodity/ore/syreline)
	high_demand_level = 25
	static_growth = 0
	current_demand_level = 60
	maximum_demand_level = 100

/demand_control/rare_crystals
	commodities = list(/commodity/ore/erebite, /commodity/ore/telecrystal, /commodity/ore/uqill)
	high_demand_level = 20
	static_growth = 1
	fluctuates = 0
...
/supply_control
	...
	proc/visibility(var/grade)
		...
		if (required)
			var/progress/P = locate(required) in C.milestones
			if (!P)
				return FALSE
			if (!P.completed)
...
/supply_control/crate
	maximum_stock = 0
	supply_packs = list(/supply_packs/emptycrate)

/supply_control/glass_kit
	maximum_stock = 3
	supply_packs = list(/supply_packs/glass50)

/supply_control/metal_kit
	maximum_stock = 3
	supply_packs = list(/supply_packs/metal50)

/supply_control/cable_kit
	maximum_stock = 3
	supply_packs = list(/supply_packs/electrical4)

/supply_control/homing_kit
	maximum_stock = 3
	replenishment_time = 18000
	supply_packs = list(/supply_packs/homing_kit)

/supply_control/cargo_kit
	maximum_stock = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/cargo_kit)

/supply_control/manufacturer_kit
	maximum_stock = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/manufacturer_kit)

/supply_control/pod_kit
	maximum_stock = 2
	replenishment_time = 9000
	supply_packs = list(/supply_packs/complex/pod_kit)
	workstation_grade = 2

/supply_control/ai_kit
	maximum_stock = 2
	replenishment_time = 36000
	supply_packs = list(/supply_packs/complex/ai_kit)
	workstation_grade = 2

/supply_control/security_camera
	maximum_stock = 0
	supply_packs = list(/supply_packs/complex/security_camera)
	workstation_grade = 2

/supply_control/mainframe_kit
	maximum_stock = 2
	replenishment_time = 36000
	supply_packs = list(/supply_packs/complex/mainframe_kit)
	workstation_grade = 2
...
/supply_control/elec_kit
	maximum_stock = 1
	supply_packs = list(/supply_packs/complex/electronics_kit)

/supply_control/mini_magnet_kit
	maximum_stock = 2
	replenishment_time = 9000
	supply_packs = list(/supply_packs/complex/mini_magnet_kit)

/supply_control/magnet_kit
	maximum_stock = 2
	replenishment_time = 36000
	supply_packs = list(/supply_packs/complex/magnet_kit)
	workstation_grade = 2

/supply_control/medkits
	maximum_stock = 1
	replenishment_time = 6000
	supply_packs = list(/supply_packs/medicalfirstaid)

/supply_control/bathroom
	maximum_stock = 5
	replenishment_time = 3000
	supply_packs = list(/supply_packs/medicalfirstaid)

/supply_control/arc_smelter
	required = /progress/rooms/cargo_bay
	maximum_stock = 2
	replenishment_time = 36000
	supply_packs = list(/supply_packs/complex/arc_smelter)
	workstation_grade = 2

/supply_control/weapon_kit
	maximum_stock = 3
	initial_stock = 1
	replenishment_time = 36000
	supply_packs = list(/supply_packs/weapons2)

/supply_control/stun_baton
	maximum_stock = 3
	initial_stock = 2
	replenishment_time = 6000
	supply_packs = list(/supply_packs/baton)

/supply_control/administrative_id
	maximum_stock = 3
	initial_stock = 2
	replenishment_time = 6000
	supply_packs = list(/supply_packs/administrative_id)

/supply_control/plasmastone
	maximum_stock = 3
	initial_stock = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/plasmastone)

/supply_control/banking
	required = /progress/rooms/cargo_bay
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/banking_kit)

/supply_control/basic_power
	required = /progress/rooms/cargo_bay
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/basic_power_kit)

/supply_control/id_computer
	required = /progress/rooms/cargo_bay
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/id_computer)

/supply_control/medical
	required = /progress/rooms/cargo_bay
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/medical_kit)

/supply_control/robotics
	required = /progress/rooms/medbay
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/robotics_kit)

/supply_control/genetics
	required = /progress/rooms/medbay
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/genetics_kit)

/supply_control/artlab
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/artlab_kit)

/supply_control/telesci
	maximum_stock = 2
	initial_stock = 2
	workstation_grade = 2
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/telescience_kit)

/supply_control/defense
	maximum_stock = 5
	initial_stock = 0
	replenishment_time = 18000
	supply_packs = list(/supply_packs/complex/turret_kit)

/supply_control/fueltank
	maximum_stock = 1
	initial_stock = 1
	replenishment_time = 18000
	supply_packs = list(/supply_packs/fueltank)

/supply_control/watertank
	maximum_stock = 1
	initial_stock = 1
	replenishment_time = 18000
	supply_packs = list(/supply_packs/watertank)

/supply_control/compostbin
	maximum_stock = 1
	initial_stock = 1
	replenishment_time = 18000
	supply_packs = list(/supply_packs/compostbin)

/supply_control/telecrystal
	maximum_stock = 6
	initial_stock = 4
	replenishment_time = 18000
	supply_packs = list(/supply_packs/telecrystal)

/supply_control/telecrystal_bulk
	maximum_stock = 3
	initial_stock = 2
	replenishment_time = 36000
	supply_packs = list(/supply_packs/telecrystal_bulk)

/supply_control/janitor
	maximum_stock = 2
	initial_stock = 2
	replenishment_time = 2500
	supply_packs = list(/supply_packs/janitor)
...
/obj/machinery/computer/special_supply
	...
	proc/is_sellable(var/obj/O)
		...
		if (O.type in unsellables_cache)
			return FALSE
		var/game_mode/construction/C = ticker.mode
		for (var/demand_control/DQ in C.special_demand_control)
			if (DQ.is_sellable(O))
	...
	proc/do_sell(var/obj/Q)
		var/game_mode/construction/C = ticker.mode
		var/demand_control/DCO = null
		var/commodity/COM = null
		if (Q.type in dccache)
			DCO = dccache[Q.type]
			COM = comcache[Q.type]
		else
			for (var/demand_control/DQ in C.special_demand_control)
				for (var/commodity/CO in DQ.commodities)
				...
				if (!in_target.is_ready())
					...
					for (var/atom/movable/O in T)
						if ((O != in_target && O.density) || istype(O, /mob/living))
							...
							attack_hand(usr)
							return
					var/supply_packs/P = locate(href_list["purchase"])
					var/supply_control/C = locate(href_list["control"])
...
.good {
	color: blue;
		...
		if (!is_powered)
			interface += "<span class='bad'><strong>Warning:</strong> workstation operating off battery power.<br><br>"
		if (message)
		...
		if (mode == 0)
			...
			interface += "<tbody>"
			for (var/supply_control/S in C.special_supply_control)
				var/vis = S.visibility(workstation_grade)
				if (vis)
					for (var/supply_packs/P in S.supply_packs)
			...
			for (var/demand_control/D in C.special_demand_control)
				...
				if (vis)
					...
					for (var/commodity/CO in all_commodities)
						var/DLI = null
