/progress
	...
	proc/announce()
		if (announce_completion)
			boutput(world, "<strong><font color='blue'>[announced_message]</font></strong>")

	proc/set_complete()
		completed = 1
		logTheThing("debug", null, null, "<strong>Marquesas/Progress</strong>: Milestone [name] complete.")
	...
	proc/uncomplete()
		...
		if (announce_uncompletion)
			boutput(world, "<strong><font color='red'>[uncompleted_message]</font></strong>")
		var/game_mode/construction/C = ticker.mode
		C.events.notify_milestone_uncomplete(src)
		logTheThing("debug", null, null, "<strong>Marquesas/Progress</strong>: Milestone [name] uncompleted.")
	...
	proc/check_uncompletion()
		...
		if (completed && !uncompletion && !is_complete)
			...
			logTheThing("debug", null, null, "<strong>Marquesas/Progress</strong>: Milestone [name] uncompleting.")
...
/progress/time/twohours
	elapsed_ticks = 90000
	is_abstract = 0
	name = "2 Hours"
	announced_message = "<strong>10 hours left until construction reset.</strong>"

/progress/time/sixhours
	elapsed_ticks = 234000
	is_abstract = 0
	name = "6 Hours"
	announced_message = "<strong>6 hours left until construction reset.</strong>"

/progress/time/ninehours
	elapsed_ticks = 342000
	is_abstract = 0
	name = "9 Hours"
	announced_message = "<strong>3 hours left until construction reset.</strong>"

/progress/time/tenhours
	elapsed_ticks = 378000
	is_abstract = 0
	name = "10 Hours"
	announced_message = "<strong>2 hours left until construction reset.</strong>"

/progress/time/elevenhours
	elapsed_ticks = 414000
	is_abstract = 0
	name = "11 Hours"
	announced_message = "<strong>1 hours left until construction reset.</strong>"

/progress/time/almostover
	elapsed_ticks = 432000
	is_abstract = 0
	name = "11 Hours and 30 Minutes"
	announced_message = "<strong>30 minutes left until construction reset.</strong>"

/progress/time/almostoverreally
	elapsed_ticks = 444000
	is_abstract = 0
	name = "11 Hours and 50 Minutes"
	announced_message = "<strong>10 minutes left until construction reset.</strong>"
...
/progress/pods
	...
	check_completion(var/turf/T)
		...
		logTheThing("debug", null, null, "<strong>Marquesas/Progress</strong>: Pod score is [pod_score].")
...
/progress/pods/tier2
	...
	is_abstract = 0
	parent = /progress/pods/tier1

/progress/pods/tier3
	name = "Pod Armaments Tier 3"
	pod_score_required = 9
	is_abstract = 0
	parent = /progress/pods/tier2
