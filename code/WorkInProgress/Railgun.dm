...
/obj/item/railgun
	...
	afterattack(atom/target as mob|obj|turf, mob/user as mob)
		...
		var/list/affected = DrawLine(loc, target_r, /obj/line_obj/railgun ,'icons/obj/projectiles.dmi',"WholeRailG",1,1,"HalfStartRailG","HalfEndRailG",OBJ_LAYER,1)
...
Example of Proper Usage (Tile-based):
  ...
  LineList.Add(DrawLine(StartingObject,EndingObject,/obj/Line,'Line.dmi',"Whole",1,1,"HalfStart","HalfEnd",OBJ_LAYER,1))

You could then access the list to see what turfs/mobs/objs/etc. the line crossed like this:

  for (var/obj/Line/L in LineList)
