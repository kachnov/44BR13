...
/proc/getBanApiFallback(searchCol="all", search="", order="DESC", offset=0, limit=10, sort="id", removed=0)
	...
	if (!q.Execute(db))
		logTheThing("debug", null, null, "<strong>Local Callback Error</strong> - callback failed in <strong>getBanApiFallback</strong> with message: <strong>Unable to query database</strong>: \[[q.Error()]\] [q.ErrorMsg()]")
