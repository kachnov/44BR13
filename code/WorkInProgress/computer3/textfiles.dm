...
/computer/file/record/c3help
	name = "helplib"
	size = 2

	New()
		..()
		fields["topics"] = "General: cls, cd, dir, root, rename, copy, paste, makedir, title, delete, run, drive, read, print, login, logout, user, time<br>System Functions: help, logging, periph, backprog, accounts, version"
		fields["logging"] = "All console commands are logged in /logs/syslog.text by default. Initlogs re-activates logging if it has been disabled."
		fields["help"] = "Syntax: help \[topic].  Prints help message on topic, if possible.<br>Information stored on external helplib record file. <br> Getting Started: The DIR command will show you a list of files in your current directory. ROOT will return you to the root directory. CD / name will change to that directory (example: cd / bin). To run programs, use RUN filename (example: run commaster) or just type the filename. <br>Type \"help topics\" to see a listing of commands."
		fields["cls"] = "Clears the terminal screen."
		fields["initlogs"] = "Re-activates logging system if disabled."
		fields["dir"] = "Displays contents of current directory."
		fields["version"] = "Display OS version information."
		fields["read"] = "Syntax: \"read \[file name].\" Display contents of text file."
		fields["print"] = "Syntax: \"print \[text].\" Print text to screen."
		fields["rename"] = "Syntax: \"rename \[target file] \[new name].\"<br>Sets name of local file to the new name."
		fields["drive"] = "Syntax: \"drive \[drive id].\"<br>Common Valid IDs: (hd0, fd0).<br>Directory will be set to root of chosen drive"
		fields["root"] = "Sets working directory to root of current drive."
		fields["copy"] = "Syntax: \"copy \[file name].\" File must be in current directory.<br>Marks file for use with Paste command."
		fields["paste"] = "Syntax: \"paste \[new name].\"<br>Pastes copy of marked file, copy will have given name."
		fields["delete"] = "Syntax: \"delete \[file name].\" Deletes supplied file, if possible.<br>Alternative command: Del."
		fields["run"] = "Syntax: \"run \[program name].\" <br>If the string begins with a forward slash /, search will begin at root of current drive.  Otherwise, it will begin within the current directory.<br>Valid executable type: .TPROG"
		fields["periph"] = "Syntax: \"periph \[mode] \[ID] \[command] \[signal file]\"<br>Valid modes: (view, command)<br>View or send commands to active peripheral cards."
		fields["cd"] = "Syntax: \"cd \[directory string]\"<br>If the string begins with a forward slash /, search will begin at root of current drive.  Otherwise, it will begin within the current directory."
		fields["makedir"] = "Syntax: \"makedir \[new directory name]\"<br>Create a new directory with given name in working directory."
		fields["title"] = "Syntax: \"title \[title name]\"<br>Set name of active drive to given title."
		fields["accounts"] = "This system manages user accounts to support user accountability.  Login to log in, logout to log out. A valid ID is required.<br>User data is stored in /logs/sysusr by default."
		fields["login"] = "Syntax: \"login\" Cannot be used with an account still active.<br>This will scan the card(s) in any active card scanner modules."
		fields["logout"] = "Syntax: \"logout\" This will clear the active account and place the system on standby."
		fields["backprog"] = "Syntax: \"backprog \[mode] \[ID]\"<br>Valid modes: (view, kill, switch)<br>Used to view, switch to, and terminate running programs in memory."
		fields["user"] = "Display current user account data, if applicable."
		fields["time"] = "Display current system time."


//Halloween Notes:
/computer/file/text/hjam_rlog_1
	name = "Log 489-C"
...
/computer/file/text/hjam_rlog_2
	name = "Log 491-D"
...
/computer/file/text/hjam_rlog_3
	name = "Log 492-A"
...
/computer/file/text/hjam_passlog
	name = "Passwords"
...
/computer/file/text/outpost_rlog_1
	name = "Log 014"
...
/computer/file/text/outpost_rlog_2
	name = "Log 017"
...
/computer/file/text/icemoon_log1
	name = "Log 001"
...
/computer/file/text/icemoon_log2
	name = "Log 002"
...
/computer/file/text/icemoon_log3
	name = "Log 003"
...
/computer/file/text/icemoon_log4
	name = "Log 004"
...
/computer/file/record/dronefact_log1
	name = "SR0210A"
...
/computer/file/record/dronefact_log2
	name = "SR0220C"
...
/computer/file/record/dronefact_log3
	name = "IRIDIUM"
