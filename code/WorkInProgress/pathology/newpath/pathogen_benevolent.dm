/pathogeneffects/benevolent
	name = "Benevolent"
	rarity = RARITY_ABSTRACT

/pathogeneffects/benevolent/mending
	name = "Wound Mending"
...
/pathogeneffects/benevolent/healing
	name = "Burn Healing"
...
/pathogeneffects/benevolent/detoxication
	name = "Detoxication"
	...
	disease_act(var/mob/M as mob, var/pathogen/origin)
		...
		for (var/rid in M.reagents.reagent_list)
			var/reagent/R = M.reagents.reagent_list[rid]
			if (rid == "ethanol" || istype(R, /reagent/fooddrink/alcoholic))
				met = 1
...
/pathogeneffects/benevolent/metabolisis
...
/pathogeneffects/benevolent/cleansing
	name = "Cleansing"
...
/pathogeneffects/benevolent/oxygenconversion
...
/pathogeneffects/benevolent/oxygenproduction
