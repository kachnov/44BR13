...
/mob/proc/addOverlaysClient(var/client/CL) //Adds the overlays of current mob to given client
	if (!CL) return
	for (var/overlayComposition/C in screenoverlays)
...
/overlayComposition
	...
	New()
		for (var/overlayDefinition/D in definitions)
...
/proc/overlaytest()
	...
	boutput(usr, "<strong><font color=\"gold\"> [overlist.len] overlays defined.</font></strong>")
...
/overlayComposition/blinded
	New()
		...
		var/overlayDefinition/fluff = new()
...
/overlayComposition/flashed
	New()
		var/overlayDefinition/beam = new()
...
/overlayComposition/heat
	New()
		var/overlayDefinition/part1 = new()
		...
		var/overlayDefinition/part2 = new()
...
/overlayComposition/static_noise
...
/overlayComposition/static_noise/sub
	special_blend = BLEND_SUBTRACT

/overlayComposition/blinded_r_eye
	New()
		var/overlayDefinition/dither = new()
		...
		var/overlayDefinition/meaty = new()
...
/overlayComposition/blinded_l_eye
	New()
		var/overlayDefinition/dither = new()
...
/overlayComposition/shuttle_warp
	var/warp_dir = "warp"
	New()
		var/overlayDefinition/warp = new()
		warp.d_icon = 'icons/effects/overlays/warp.dmi'
		warp.d_icon_state = warp_dir
		warp.d_blend_mode = 1
...
/overlayComposition/shuttle_warp/ew
	warp_dir = "warp_ew"
