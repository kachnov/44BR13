...
/modular_recipe/flash
	recipe_name = "flash"
	recipe_desc = "A flash."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/energy_cell_small(src))
		recipe_parts.Add(new/modular_component/material_metal(src))
		recipe_parts.Add(new/modular_component/lens(src))
		return ..(w)

	create()
		var/obj/item/device/flash/newObj = new()
		var/modular_component/cell = recipe_parts[1] //This should be the energy cell if order is preserved.
		var/modular_component/metal = recipe_parts[2] //This should be the metal if order is preserved.
		var/modular_component/lens = recipe_parts[3] //This should be the lens if order is preserved.
...
/modular_recipe/flashlight
	recipe_name = "flashlight"
	recipe_desc = "A flashlight."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/energy_cell_large(src))
		recipe_parts.Add(new/modular_component/material_metal(src))
		recipe_parts.Add(new/modular_component/lens(src))
		return ..(w)
...
/modular_recipe/arrowhead
	recipe_name = "arrowhead"
	recipe_desc = "A few arrowheads."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/material_metal_or_crystal(src))
		return ..(w)
...
/modular_recipe/lens
	...
	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/material_crystal(src))
		return ..(w)
...
/modular_recipe/sheets_ten
	recipe_name = "10 sheets"
	recipe_desc = "10 sheets of a given material."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/material_any(src))
		return ..(w)
...
/modular_recipe/jumpsuit
	recipe_name = "jumpsuit"
	recipe_desc = "A simple jumpsuit."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/material_fabric(src))
		return ..(w)
...
/modular_recipe/armorplates
	recipe_name = "armor plates"
	recipe_desc = "Some armor plates."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/tile/three(src))
		recipe_parts.Add(new/modular_component/rods_5(src))
		return ..(w)

	create()
		var/obj/item/aplate/newObj = new()
		var/modular_component/tiles = recipe_parts[1]
		var/modular_component/rods = recipe_parts[2]
...
/modular_recipe/harmor
	recipe_name = "heavy armor"
	recipe_desc = "heavy armor."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/aplate(src))
		recipe_parts.Add(new/modular_component/rods_5(src))
		return ..(w)

	create()
		var/obj/item/clothing/suit/armor/heavy/newObj = new()
		var/modular_component/plates = recipe_parts[1]
		var/modular_component/rods = recipe_parts[2]
...
/modular_recipe/podarmor
	...
	New(var/obj/workbench/w)
		...
		recipe_parts.Add(new/modular_component/rods_5(src))
		recipe_parts.Add(new/modular_component/material_crystal(src))
		recipe_parts.Add(new/modular_component/gears(src))
		return ..(w)
...
/modular_recipe/cablecoil
	...
	create()
		...
		var/modular_component/C = recipe_parts[1] //Insulator
		var/modular_component/C2 = recipe_parts[2] //Conductor
...
/modular_recipe/tripod
	recipe_name = "tripod"
	recipe_desc = "A 3-legged stand for supporting various devices."

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/rods_3(src))
		return ..(w)
...
/modular_recipe/eguncellswap
	...
	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/egun(src))
		recipe_parts.Add(new/modular_component/energy_cell_small(src))
		return ..(w)

	create()
		var/modular_component/gun = recipe_parts[1]
		var/modular_component/cell = recipe_parts[2]
...
/modular_recipe/batoncellswap
	recipe_name = "Swap stun baton cell"
	recipe_desc = "Allows you to switch out the energy cell used by a stun baton."
	manual_component_handling = 1

	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/baton(src))
		recipe_parts.Add(new/modular_component/energy_cell_small(src))
		return ..(w)

	create()
		var/modular_component/baton = recipe_parts[1]
		var/modular_component/cell = recipe_parts[2]
...
/modular_recipe/meleeweapon
	...
	New(var/obj/workbench/w)
		recipe_parts.Add(new/modular_component/item_any/core(src))
		recipe_parts.Add(new/modular_component/item_any/head(src))
		return ..(w)

	create()
		var/modular_component/core = recipe_parts[1]
		var/modular_component/head = recipe_parts[2]
...
//COMPONENTS START//
/modular_component/item_any/core
	component_name = "any item (core)"

/modular_component/item_any/head
	component_name = "any item (head)"

/modular_component/item_any
	component_name = "any item"
	component_desc = "This slot requires an item of any type."
	icon_state = "pocket"

	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item)) return TRUE
		return FALSE

/modular_component/material_any
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			return TRUE
		return FALSE

/modular_component/material_metal
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_METAL) return TRUE
		return FALSE

/modular_component/material_crystal
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_CRYSTAL) return TRUE
		return FALSE

/modular_component/material_metal_or_crystal
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_CRYSTAL || A.material.material_flags & MATERIAL_METAL) return TRUE
		return FALSE

/modular_component/material_fabric
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_CLOTH) return TRUE
		return FALSE

/modular_component/material_rubber
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_RUBBER) return TRUE
		return FALSE

/modular_component/material_organic
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_ORGANIC) return TRUE
		return FALSE

/modular_component/material_energy
	...
	check_match(var/obj/item/A)
		...
		if (!istype(A,/obj/item/raw_material) && !istype(A,/obj/item/material_piece)) return FALSE
		if (A.material)
			if (A.material.material_flags & MATERIAL_ENERGY) return TRUE
		return FALSE

/modular_component/energy_cell_small
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/ammo/power_cell)) return TRUE
		return FALSE

/modular_component/energy_cell_large
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/cell)) return TRUE
		return FALSE

/modular_component/lens
	component_name = "lens"
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/lens)) return TRUE
		return FALSE

/modular_component/gears
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/gears)) return TRUE
		return FALSE

/modular_component/rods_3
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/rods)) return TRUE
		return FALSE

/modular_component/rods_5
...
/modular_component/aplate
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/aplate)) return TRUE
		return FALSE

/modular_component/tile
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/tile)) return TRUE
		return FALSE

/modular_component/tile/three
	component_name = "3 floor tiles"
	component_desc = "This slot requires 3 floor tiles."
	icon_state = "tile"
	required_amount = 3

/modular_component/egun
	...
	check_match(var/obj/item/A)
		if (!..(A)) return FALSE //This checks for the amount.
		if (istype(A,/obj/item/gun/energy)) return TRUE
		return FALSE

/modular_component/baton
