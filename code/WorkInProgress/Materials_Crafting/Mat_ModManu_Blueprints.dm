/*///////RECIPE DATUMS
/manufacturer_blueprint/sunglasses
	name = "Sunglasses"
	...
	setParts()
		part_list.Add("Glass")
		part_list["Glass"] = new/manufacturer_part(MATERIAL_CRYSTAL, "Glass")
		return

	assemble(var/atom/owner)
		for (var/manufacturer_part/P in part_list)
		...
		var/manufacturer_part/part1 = part_list["Glass"]
		G.setMaterial(part1.assigned.material)
		return TRUE


/manufacturer_blueprint/mop
	name = "Mop"
	desc = "A mop."
	assembly_time = 40
	...
	setParts()
		part_list.Add("Metal")
		part_list["Metal"] = new/manufacturer_part(MATERIAL_METAL, "Metal")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Metal"]
		G.setMaterial(part1.assigned.material)
		return TRUE

/manufacturer_blueprint/basketball
	name = "Basketball"
	desc = "A basketball."
	assembly_time = 40
	...
	setParts()
		...
		part_list["Rubber"] = new/manufacturer_part(MATERIAL_RUBBER, "Rubber")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Rubber"]
		G.setMaterial(part1.assigned.material)
		return TRUE

/manufacturer_blueprint/baton
	name = "Baton"
...
/manufacturer_blueprint/bulletstwentytwo
...
/manufacturer_blueprint/wateringcan
	name = "Watering can"
	desc = "A watering can."
	assembly_time = 40
...
/manufacturer_blueprint/chainsaw
	name = "Chainsaw"
	desc = "A chainsaw."
	assembly_time = 80
	...
	setParts()
		...
		part_list["Energy"] = new/manufacturer_part(MATERIAL_ENERGY, "Energy source")
		return
...
/manufacturer_blueprint/shoes
	...
	setParts()
		...
		part_list["Fabric"] = new/manufacturer_part(MATERIAL_CLOTH, "Fabric")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Fabric"]

		var/material/M = part1.assigned.material

		G.setMaterial(M)
		return TRUE

/manufacturer_blueprint/rollingpin
	name = "Rolling pin"
	desc = "A rolling pin."
	assembly_time = 40
...
/manufacturer_blueprint/handcuffs
	name = "Handcuffs"
	desc = "Some handcuffs."
	assembly_time = 40
...
/manufacturer_blueprint/spaceset
	name = "Space suit set"
	...
	setParts()
		...
		part_list["Padding"] = new/manufacturer_part(MATERIAL_CLOTH, "Padding")

		part_list.Add("Reinforment")
		part_list["Reinforment"] = new/manufacturer_part(MATERIAL_METAL, "Reinforment")

		part_list.Add("Jetpack")
		part_list["Jetpack"] = new/manufacturer_part(MATERIAL_METAL, "Jetpack metal")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Fabric"]
		var/manufacturer_part/part2 = part_list["Jetpack"]
...
/manufacturer_blueprint/gasmask
	name = "Gas mask"
...
/manufacturer_blueprint/gastank
	name = "Gas tank"
...
/manufacturer_blueprint/beakers
	name = "Beaker box"
	...
	setParts()
		...
		part_list["Material"] = new/manufacturer_part(MATERIAL_CRYSTAL, "Material")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Material"]
...
/manufacturer_blueprint/labcoat
	name = "Labcoat"
...
/manufacturer_blueprint/firesuit
	name = "Firesuit"
...
/manufacturer_blueprint/cutlery
	name = "Cutlery set"
...
/manufacturer_blueprint/extinguisher
	name = "Extinguisher"
...
/manufacturer_blueprint/toolbox_emergency
...
/manufacturer_blueprint/toolbox_electrical
...
/manufacturer_blueprint/toolbox_mechanical
...
/manufacturer_blueprint/glasssheet10
	...
	setParts()
		part_list.Add("Panel")
		part_list["Panel"] = new/manufacturer_part(MATERIAL_CRYSTAL, "Panel")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Panel"]
		G.setMaterial(part1.assigned.material)
		G.amount = 10
		return TRUE

/manufacturer_blueprint/metalsheet10
	...
	setParts()
		part_list.Add("Panel")
		part_list["Panel"] = new/manufacturer_part(MATERIAL_METAL, "Panel")
		return
...
/manufacturer_blueprint/slagshovel
	name = "Slag shovel"
	...
	setParts()
		...
		part_list["Shovel"] = new/manufacturer_part(MATERIAL_METAL, "Shovel")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Shovel"]
		G.setMaterial(part1.assigned.material)
		return TRUE

/manufacturer_blueprint/gloves
	name = "Gloves"
	desc = "Simple gloves."
	assembly_time = 30
...
/manufacturer_blueprint/jumpsuit
	name = "Jumpsuit"
...
/manufacturer_blueprint/podarmor
	name = "Pod Armor"
	...
	setParts()
		...
		part_list["Armor plating"] = new/manufacturer_part(MATERIAL_METAL, "Armor plating")

		part_list.Add("Coating")
		part_list["Coating"] = new/manufacturer_part(MATERIAL_CRYSTAL, "Coating")

		part_list.Add("Bolts")
		part_list["Bolts"] = new/manufacturer_part(MATERIAL_METAL, "Bolts")

		part_list.Add("Struts")
		part_list["Struts"] = new/manufacturer_part(MATERIAL_METAL, "Struts")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Armor plating"]
		G.setMaterial(part1.assigned.material)
		return TRUE

/manufacturer_blueprint/harmor
	name = "Heavy Armor"
	...
	setParts()
		...
		part_list["Plating"] = new/manufacturer_part(MATERIAL_METAL, "Plating")
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Plating"]
...
/manufacturer_blueprint/horse
	...
	setParts()
		part_list.Add("Mask")
		part_list["Mask"] = new/manufacturer_part(MATERIAL_METAL, "Mask")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Mask"]
		G.setMaterial(part1.assigned.material)
		return TRUE

/manufacturer_blueprint/gtank
	name = "Atmos Canister"
	...
	setParts()
		part_list.Add("Hull")
		part_list["Hull"] = new/manufacturer_part(MATERIAL_METAL, "Hull")
		return
	...
	assemble(var/atom/owner)
		...
		var/manufacturer_part/part1 = part_list["Hull"]
		G.setMaterial(part1.assigned.material)
		return TRUE
...
/obj/item/man_blueprint/horsemask
	...
	bpType = /manufacturer_blueprint/horse

/obj/item/man_blueprint/sunglasses
	name = "sunglasses blueprint"
	bpType = /manufacturer_blueprint/sunglasses

/obj/item/man_blueprint/mop
	name = "mop blueprint"
	bpType = /manufacturer_blueprint/mop

/obj/item/man_blueprint/basketball
	name = "basketball blueprint"
	bpType = /manufacturer_blueprint/basketball
///////RECIPE OBJECTS
*/