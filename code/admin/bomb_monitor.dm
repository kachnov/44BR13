	...
	proc/display_ui()
		...
		for (var/obj/item/device/transfer_valve/TV in TVs)
			if (!filter_active_only || (TV.tank_one || TV.tank_two))
				...
				temp += {"<tr>
							...
							<td>
								<a href='?src=\ref[src];trigger=\ref[TV]'><strong>[TV.tank_one && TV.tank_two ? "Trigger" : ""]</strong></a>
							</td>
						</tr>"}
		...
		for (var/obj/item/assembly/proximity_bomb/PB in ST_prox)
			...
			temp += {"<tr>
						...
						<td>
							<a href='?src=\ref[src];trigger=\ref[PB]'><strong>[PB.part3 ? "Trigger" : ""]</strong></a>
						</td>
					</tr>"}
		...
		for (var/obj/item/assembly/time_bomb/TB in ST_time)
			...
			temp += {"<tr>
						...
						<td>
							<a href='?src=\ref[src];trigger=\ref[TB]'><strong>[TB.part3 ? "Trigger" : ""]</strong></a>
						</td>
					</tr>"}
		...
		for (var/obj/item/assembly/radio_bomb/RB in ST_radio)
			...
			temp += {"<tr>
						...
						<td>
							<a href='?src=\ref[src];trigger=\ref[RB]'><strong>[RB.part3 ? "Trigger" : ""]</strong></a>
						</td>
					</tr>"}
		...
		for (var/obj/item/assembly/detonator/det in dets)
			if (!filter_active_only || det.attachedTo)
				...
				temp += {"<tr>
							...
							<td>
								<a href='?src=\ref[src];trigger=\ref[det]'><strong>[det.attachedTo ? "Trigger" : ""]</strong></a>
							</td>
						</tr>"}
