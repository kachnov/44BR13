...
/material_property/tensile
	name = PROP_TENSILE
	value = 10
	value_max = 100
	value_min = 1

/material_property/compressive
	name = PROP_COMPRESSIVE
	value = 10
	value_max = 100
	value_min = 1

/material_property/shear
	name = PROP_SHEAR
	value = 10
	value_max = 100
	value_min = 1

/material_property/hardness
	name = PROP_HARDNESS
	value = 10
	value_max = 100
	value_min = 1
...
/material_property/reflectivity
	name = PROP_REFLECT
	value = 10
	value_max = 100
	value_min = 1

/material_property/scattering
	name = PROP_SCATTER
	value = 30
	value_max = 100
	value_min = 1

/material_property/luminosity
	name = PROP_LUMINOSITY
	value = 1
	value_max = 10
	value_min = 1

/material_property/flammability
	name = PROP_FLAMMABILITY
	value = 50
	value_max = 100
	value_min = 1

/material_property/thermal
	name = PROP_THERMAL
	value = 10
	value_max = 100
	value_min = 1

/material_property/melting
	name = PROP_MELTING
	value = T0C + 1000
	value_max = INFINITY
	value_min = 1

/material_property/crittemp
	name = PROP_CRITTEMP
	value = T0C - 269
	value_max = INFINITY
	value_min = -INFINITY
...
/material_property/dielectric
	name = PROP_DIELECTRIC
	value = 10
	value_max = 100
	value_min = 1

/material_property/permittivity
	name = PROP_PERMITTIVITY
	value = 10
	value_max = 100
	value_min = 1

/material_property/corrosion
	name = PROP_CORROSION
	value = 1
	value_max = 100
	value_min = 1

/material_property/radioactivity
