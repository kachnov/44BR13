/client/verb/RPRules()
	...
	<span style='size:1.5em'><strong>Warning:</strong> This server is intended for undisturbed roleplay. We will be cracking down very strictly on people who think this is the same as #4. You have been warned.</span>
