...
/artifact/
	...
	var/artifact_origin/artitype = null
	...
	var/validtriggers = list(/artifact_trigger/force,/artifact_trigger/electric,/artifact_trigger/heat,
	...
	proc/effect_activate(var/obj/O)
		...
		ArtifactLogs(usr, null, O, "activated", null, istype(src, /artifact/bomb) ? 1 : 0)
		return FALSE
	...
	proc/get_trigger_by_string(var/string)
		if (!istext(string))
			return null
		for (var/artifact_trigger/AT in triggers)
...
/projectile/artifact
	...
	proc/randomise()
		...
		shot_sound = pick('sound/weapons/Taser.ogg','sound/weapons/flaregun.ogg','sound/weapons/Laser.ogg','sound/weapons/laserheavy.ogg','sound/weapons/laserlight.ogg','sound/weapons/lasermed.ogg','sound/weapons/laserultra.ogg','sound/weapons/grenade.ogg','sound/weapons/rocket.ogg','sound/weapons/snipershot.ogg','sound/weapons/TaserOLD.ogg','sound/weapons/ACgun1.ogg','sound/weapons/ACgun2.ogg')
		...
		damage_type = pick(D_KINETIC,D_PIERCING,D_SLASHING,D_ENERGY,D_BURNING,D_RADIOACTIVE,D_TOXIC)
		power = rand(2,50)
		dissipation_rate = rand(1,power)
		dissipation_delay = rand(1,10)
		ks_ratio = pick(0, 1, prob(10); (rand(0, 10000) / 10000))
