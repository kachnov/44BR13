/obj/machinery/artifact/noisy_thing
	...
	associated_datum = /artifact/noisy_thing

	ArtifactDeactivated()
		return // hahaha nope

/artifact/noisy_thing
	...
	New(var/loc, var/forceartitype)
		...
		spamsound = pick(sounds)
		sound_pitch = rand(2,20)
		sound_pitch /= 10
		times_to_play = rand(1,3)
		var/harmprob = 5
	...
	effect_process(var/obj/O)
		...
		if (evil)
			...
			while (loops > 0)
				loops--
				playsound(T, spamsound, 200, 1, 0, sound_pitch)
