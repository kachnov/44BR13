/obj/artifact/borgifier
	...
	associated_datum = /artifact/borgifier
...
/artifact/borgifier
	...
	effect_touch(var/obj/O,var/mob/living/user)
		...
		if (istype(user,/mob/living/carbon/human))
			...
			boutput(user, "<span style=\"color:red\">An imperious voice rings out in your head... \"<strong>HUNT BIOLOGICALS FOR UPGRADING\"</span>")
		else
			return