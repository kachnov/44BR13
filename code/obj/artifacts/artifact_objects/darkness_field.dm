/obj/artifact/darkness_field
	...
	associated_datum = /artifact/darkness_field

/artifact/darkness_field
	...
	effect_activate(var/obj/O)
		if (..())
			return
		O.visible_message("<span style=\"color:red\"><strong>[O]</strong> emits a wave of absolute darkness!</span>")
		O.anchored = 1
