...
/obj/spawner/bomb/New()
	...
	switch (btype)
		// radio
		if (0)
			var/obj/item/assembly/radio_bomb/R = new /obj/item/assembly/radio_bomb(loc)
		...
		// proximity
		if (1)
			var/obj/item/assembly/proximity_bomb/R = new /obj/item/assembly/proximity_bomb(loc)
			var/obj/item/tank/plasma/p3 = new /obj/item/tank/plasma(R)
		...
		// timer
		if (2)
			var/obj/item/assembly/time_bomb/R = new /obj/item/assembly/time_bomb(loc)
			var/obj/item/tank/plasma/p3 = new /obj/item/tank/plasma(R)
...
/obj/spawner/briefcasebomb/New()
	...
	var/obj/item/device/transfer_valve/briefcase/V = new(loc)
	var/obj/item/tank/plasma/PT = new(V)
	var/obj/item/tank/oxygen/OT = new(V)
...
/obj/bomberman
	...
	proc/explode()
		...
		for (var/turf/T in oview(3, src))
			if ((T.x != x && T.y != y) || T.density)
				continue
			var/dist = get_dist(loc, T)
			var/rel_dir = get_dir(loc, T)
			if (dist <= 3)
				for (var/atom/A in T)
		...
		playsound(loc, "explosion", 100, 1)
		playsound(loc, "sound/effects/explosionfar.ogg", 100, 1, 14)
		sleep(10)
		animation.dispose()
