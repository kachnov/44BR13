...
//					if (istype(trace_gas, /gas/oxygen_agent_b))
...
/obj/machinery/portable_atmospherics/scrubber/attack_hand(var/mob/user as mob)
	...
	if (holding)
		holding_text = {"<BR><strong>Tank Pressure</strong>: [holding.air_contents.return_pressure()] KPa<BR>
<A href='?src=\ref[src];remove_tank=1'>Remove Tank</A><BR>
"}
	var/output_text = {"<TT><strong>[name]</strong><BR>
