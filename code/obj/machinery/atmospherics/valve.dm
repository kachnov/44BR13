/obj/machinery/atmospherics/valve
	...
	var/pipe_network/network_node1
	var/pipe_network/network_node2
	...
	attack_hand(mob/user as mob)
		update_icon(1)
		sleep(10)
		logTheThing("station", user, null, "has [open ? "closed" : "opened"] the valve: [src] at [log_loc(src)]")
		if (open)
			close()
		else
			open()
...
/obj/machinery/atmospherics/manifold_valve
	...
	var/pipe_network/network_node1
	var/pipe_network/network_node2
	var/pipe_network/network_node3
	...
	build_network()
		...
		if (!network_node3 && node3)
			network_node3 = new /pipe_network()
