...
/obj/machinery/power/generator_type2/process()
	...
	var/gas_mixture/air1 = input1.return_exchange_air()
	var/gas_mixture/air2 = input2.return_exchange_air()


	lastgen = 0

	if (air1 && air2)
		var/gas_mixture/hot_air = air1
		var/gas_mixture/cold_air = air2
