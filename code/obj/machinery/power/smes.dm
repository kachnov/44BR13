...
/obj/machinery/power/smes/process()
	...
	if (online)		// if outputting
		if (prob(5))
			spawn (1)
				playsound(loc, pick(ambience_power), 60, 1)
...
/obj/machinery/power/smes/proc/interact(mob/user)
	...
	var/t = "<TT><strong>SMES Power Storage Unit</strong> [n_tag? "([n_tag])" : null]<HR><PRE>"

	t += "Stored capacity : [round(100.0*charge/capacity, 0.1)]%<BR><BR>"

	t += "Input: [charging ? "Charging" : "Not Charging"]    [chargemode ? "<strong>Auto</strong> <A href = '?src=\ref[src];cmode=1'>Off</A>" : "<A href = '?src=\ref[src];cmode=1'>Auto</A> <strong>Off</strong> "]<BR>"
