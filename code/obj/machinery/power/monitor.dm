...
/obj/machinery/power/monitor/proc/interact(mob/user)
	...
	user.machine = src
	var/t = "<TT><strong>Power Monitoring</strong><HR>"
	...
	if (!powernet)
		...
		t += "<PRE>Total power: [engineering_notation(powernet._avail)]W<BR>Total load:  [engineering_notation(powernet.viewload)]W<BR>"
...
/obj/machinery/power/monitor/smes/interact(mob/user)
	...
	user.machine = src
	var/t = "<TT><strong>Engine and SMES Monitoring</strong><HR>"
	...
	if (!powernet)
		...
		t += "<PRE>Engine Output: [engineering_notation(powernet._avail)]W<BR>SMES/PTL Draw:     [engineering_notation(powernet.viewload)]W<BR>"
