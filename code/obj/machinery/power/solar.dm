...
/obj/machinery/power/tracker
	...
	// called by sun/calc_position() as sun's angle changes
...
/obj/machinery/power/solar_control/proc/interact(mob/user)
	...
	var/t = "<TT><strong>Solar Generator Control</strong><HR><PRE>"
	t += "Generated power : [round(lastgen)] W<BR><BR>"
	t += "<strong>Orientation</strong>: [rate_control(src,"cdir","[cdir]&deg",1,15)] ([angle2text(cdir)])<BR><BR><BR>"
	...
	switch(track)
		if (0)
			t += "<strong>Off</strong> <A href='?src=\ref[src];track=1'>Timed</A> <A href='?src=\ref[src];track=2'>Auto</A><BR>"
		if (1)
			t += "<A href='?src=\ref[src];track=0'>Off</A> <strong>Timed</strong> <A href='?src=\ref[src];track=2'>Auto</A><BR>"
		if (2)
			t += "<A href='?src=\ref[src];track=0'>Off</A> <A href='?src=\ref[src];track=1'>Timed</A> <strong>Auto</strong><BR>"
	...
	if (href_list["rate control"])
		if (href_list["cdir"])
			...
			spawn (1)
				...
				updateicon()
		if (href_list["tdir"])
			trackrate = dd_range(-7200,7200,trackrate+text2num(href_list["tdir"]))
			if (trackrate) nexttime = world.timeofday + 3600/abs(trackrate)
