/obj/machinery/glass_recycler
	...
	attack_hand(mob/user as mob)
		var/dat = "<strong>Glass Left</strong>: [glass_amt]<br>"
	...
	proc/create(var/object)
		if (!check_glass())
			visible_message("<span style=\"color:red\">[src] doesn't have enough glass!</span>")
			return
		...
		if (object != "plate")
			visible_message("<span style=\"color:blue\">[src] manufactures a [object] glass!</span>")
			return
		else
			visible_message("<span style=\"color:blue\">[src] manufactures a glass plate!</span>")
			return