...
/obj/machinery/bot/secbot/emagged
	...
	New()
		..()
		name = pick("Commissar Beepevich","The Beeper","Murderbot","Killtron","Lawmaker")
		spawn (600)
			if (src && blow_up == 1)
				explode()
		return
...
/obj/machinery/bot/medbot/mysterious/emagged
	...
	New()
		..()
		name = pick("Herr Doktor","Heals McGee","Wild-Eye","Jack","Boston Strangler","Insanobot")
		spawn (600)
			if (src && blow_up == 1)
				explode()
		return
...
/obj/machinery/bot/firebot/emagged
	...
	New()
		..()
		name = pick("Montag","Fire-Killer","Burns","Murdermaster","Guardbot","Axe Man")
		spawn (600)
			if (src && blow_up == 1)
				explode()
		return
...
/obj/machinery/bot/cleanbot/emagged
	...
	New()
		..()
		name = pick("Mr. Clean","Slip-o-Matic","The Janitor","Port-a-Lube","Galoshes-be-Gone","Slipmeister")
		spawn (600)
			if (src && blow_up == 1)
				explode()
		return
