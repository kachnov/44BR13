...
/obj/item/clothing/under/experimental
	...
	proc/update_images()
		...
		for (var/C as anything in component_images)
			list_counter++
			var/image/suit_image = image(icon = wear_image_icon, icon_state = C, layer = MOB_CLOTHING_LAYER)
			suit_image.icon_state = C
			suit_image.alpha = component_alphas[list_counter]
			suit_image.color = component_colors[list_counter]
			images += suit_image
...
/obj/item/clothing/under/shorts/random/New()
	..()
...
/obj/item/clothing/under/jersey/blue
...
/obj/item/clothing/under/jersey/random
...
/obj/item/clothing/under/jersey/random/New()
	..()
	color = random_saturated_hex_color(1)
...
/obj/item/clothing/under/swimsuit/random/New()
	..()
	color = random_saturated_hex_color(1)
...
/obj/item/clothing/under/shirt_pants
	...
	New()
		..()
		icon_state = "shirt_n_pant-[pick("b", "br", "w")][pick("", "_tie-r", "_tie-b", "_tie-bl")]"
