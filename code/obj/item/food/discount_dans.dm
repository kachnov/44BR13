...
/obj/item/reagent_containers/food/drinks/noodlecup
	...
	New()
		...
		switch( rand(1, 14))
			...
			if (10)
				name = "Rabatt Dan's Snabb-Nudlar - Inkokt Lax Sm�rg�sbord Smak"
...
/obj/item/reagent_containers/food/snacks/burrito
	...
	New()
		...
		switch(rand(1, 9))
			...
			if (9)
				name = "Descuento Danito's Burritos - Inside Out Burrito"
	...
	attack_self(mob/user as mob)
		...
		if (prob(10) || user.bioHolder.HasEffect("hulk"))
			user.visible_message("<span style=\"color:red\"><strong>[user]</strong> snaps the burrito in half!</span>", "<span style=\"color:red\">You accidentally snap the burrito apart. Fuck!</span>")
			splat()
			return
