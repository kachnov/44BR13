...
/computer/file/pda_program/scan
	return_text()
	...
	electronics
		...
		scan_atom(atom/A as obj)
			...
			if (!istype(master.host_program, /computer/file/pda_program/os/main_os) || !master.host_program:message_on)
				return "<span style=\"color:red\">Messaging must be on to communicate with engineering kit.</span>"

			var/computer/file/electronics_scan/theScan = new
...
/computer/file/electronics_scan
	name = "scanfile"
	extension = "OSCN"
