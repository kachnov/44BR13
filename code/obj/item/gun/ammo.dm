...
/obj/item/ammo/bullets
	...
	var/amount_left = 0.0
	var/max_amount = 1000
	ammo_type = new/projectile/bullet
	...
	New()
		spawn (20)
			update_icon() // So we get dynamic updates right off the bat. Screw static descs.
		return
	...
	update_icon()
		...
		desc = text("There are [] bullet\s left!", amount_left)

		if (amount_left > 0)
			if (icon_dynamic && icon_short)
				icon_state = text("[icon_short]-[amount_left]")
		else
			if (icon_empty)
...
/obj/item/ammo/bullets/derringer
	...
	amount_left = 2.0
	max_amount = 2.0
	ammo_type = new/projectile/bullet/derringer
	caliber = 0.41
	icon_dynamic = 1
	icon_short = "357"
	icon_empty = "357-0"
...
/obj/item/ammo/bullets/custom
	...
	amount_left = 8.0
	max_amount = 8.0
	ammo_type = new/projectile/bullet/custom
	caliber = 0.22
	icon_dynamic = 1
	icon_short = "custom"
	icon_empty = "custom-0"
...
/obj/item/ammo/bullets/bullet_22
	...
	amount_left = 10.0
	max_amount = 10.0
	ammo_type = new/projectile/bullet/bullet_22
	caliber = 0.22
...
/obj/item/ammo/bullets/a357
	...
	amount_left = 7.0
	max_amount = 7.0
	ammo_type = new/projectile/bullet/revolver_357
	caliber = 0.357
	icon_dynamic = 1
	icon_short = "38"
...
/obj/item/ammo/bullets/a357/AP
	...
	icon_state = "38A-7"
	ammo_type = new/projectile/bullet/revolver_357/AP
	icon_dynamic = 1
	icon_short = "38A"
	icon_empty = "speedloader_empty"
...
/obj/item/ammo/bullets/a38
	...
	amount_left = 7.0
	max_amount = 7.0
	ammo_type = new/projectile/bullet/revolver_38
	caliber = 0.38
	icon_dynamic = 1
	icon_short = "38"
	icon_empty = "speedloader_empty"
...
/obj/item/ammo/bullets/a38/AP
	...
	amount_left = 7.0
	max_amount = 7.0
	ammo_type = new/projectile/bullet/revolver_38/AP
	icon_dynamic = 1
	icon_short = "38A"
	icon_empty = "speedloader_empty"
...
/obj/item/ammo/bullets/a38/stun
	...
	amount_left = 7.0
	max_amount = 7.0
	ammo_type = new/projectile/bullet/revolver_38/stunners
	icon_dynamic = 1
	icon_short = "38S"
	icon_empty = "speedloader_empty"
...
/obj/item/ammo/bullets/a12
	...
	ammo_type = new/projectile/bullet/a12
	icon_state = "12"
	amount_left = 8.0
	max_amount = 8.0
	caliber = 0.72
...
/obj/item/ammo/bullets/aex
	...
	ammo_type = new/projectile/bullet/aex
	icon_state = "AEX"
	amount_left = 8.0
	max_amount = 8.0
	caliber = 0.72
...
/obj/item/ammo/bullets/abg
	...
	ammo_type = new/projectile/bullet/abg
	icon_state = "bg"
	amount_left = 8.0
	max_amount = 8.0
	caliber = 0.72
...
/obj/item/ammo/bullets/ak47
	...
	name = "AK magazine"
	ammo_type = new/projectile/bullet/ak47
	icon_state = "ak47"
	amount_left = 30.0
	max_amount = 30.0
	caliber = 0.308
...
/obj/item/ammo/bullets/rifle_3006
	...
	ammo_type = new/projectile/bullet/rifle_3006
...
/obj/item/ammo/bullets/tranq_darts
	...
	ammo_type = new/projectile/bullet/tranq_dart
	...
	syndicate
		...
		ammo_type = new/projectile/bullet/tranq_dart/syndicate

	anti_mutant
		sname = ".308 Mutadone"
		name = ".308 mutadone darts"
		ammo_type = new/projectile/bullet/tranq_dart/anti_mutant

/obj/item/ammo/bullets/vbullet
	sname = "VR bullets"
	name = "VR magazine"
	ammo_type = new/projectile/bullet/vbullet
	icon_state = "ak47"
	amount_left = 200
...
/obj/item/ammo/bullets/flare
	...
	max_amount = 8
	icon_state = "12"
	ammo_type = new/projectile/bullet/flare
	caliber = 0.72
	icon_dynamic = 0
	icon_empty = "12-0"
...
/obj/item/ammo/bullets/autocannon
	...
	max_amount = 2
	icon_state = "40mmR"
	ammo_type = new/projectile/bullet/autocannon
	caliber = 1.57
	w_class = 3
	icon_dynamic = 0
	icon_empty = "40mmR-0"
...
/obj/item/ammo/bullets/smoke
	...
	max_amount = 5
	icon_state = "40mmB"
	ammo_type = new/projectile/bullet/smoke
	caliber = 1.57
	w_class = 3
	icon_dynamic = 0
	icon_empty = "40mmB-0"
...
/obj/item/ammo/bullets/rpg
	...
	ammo_type = new /projectile/bullet/rpg
	caliber = 1.58
	w_class = 3
	delete_on_reload = 1
...
/obj/item/ammo/bullets/rod
	...
	icon = 'icons/obj/projectiles.dmi'
	icon_state = "rod_1"
	ammo_type = new/projectile/bullet/rod
	caliber = 1.0
...
/obj/item/ammo/power_cell
	...
	examine()
		if (artifact)
			...
			return
		..()
		boutput(usr, "There are [charge]/[max_charge] PU left!")
		return
	...
	proc
		charge(var/amt = 0)
			if (charge >= max_charge)
				...
				if (amt > 0)
					charge = min(charge + amt, max_charge)
					update_icon()
					return TRUE
				else
					return FALSE
...
/obj/item/ammo/power_cell/self_charging
	...
	process()
		cycle = !cycle // Charge every four seconds.
		if (cycle)
			return

		charge = min(charge + recharge_rate, max_charge)
		update_icon()
		if (charge >= max_charge)
			processing_items.Remove(src)
		return
