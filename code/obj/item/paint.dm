...
/obj/machinery/vending/paint
	...
	emag_act(var/mob/user, var/obj/item/card/emag/E)
		...
		if (prob(5))
			var/obj/item/paint_can/rainbow/plaid/P = new/obj/item/paint_can/rainbow/plaid(loc)
			if (user)
				boutput(user, "<span style=\"color:blue\">You hear a faint droning sound. Like a tiny set of bagpipes.</span>")
			P.uses = (15 * 7)
			P.generate_icon()
		else
			var/obj/item/paint_can/rainbow/P = new/obj/item/paint_can/rainbow(loc)
			P.uses = (15 * 7)
			P.generate_icon()
	...
	attack_hand(mob/user as mob)
		...
		if (col_new)
			var/obj/item/paint_can/P = new/obj/item/paint_can(loc)
...
/obj/item/paint_can/rainbow
	...
	New()
		...
		colorlist = list(rgb(255,0,0),rgb(255,165,0), rgb(255,255,0), rgb(0,128,0), rgb(0,0,255), rgb(075,0,128), rgb(238,128,238))
		currentcolor = 1
		paint_color = colorlist[currentcolor]
...
/obj/item/paint_can/rainbow/plaid
	...
	New()
		...
		patternlist = list("tartan", "strongplaid", "polka", "hearts")
		currentpattern = 1
