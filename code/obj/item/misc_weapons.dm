...
/obj/item/sword/suicide(var/mob/user as mob)
	...
	user.visible_message("<span style=\"color:red\"><strong>[user] stabs the cyalume saber through \his chest.</strong></span>")
