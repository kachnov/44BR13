/obj/item/paper/book
	...
	suicide(var/mob/user as mob)
		user.visible_message("<span style=\"color:red\"><strong>[user] attempts to cut \himself with the book. What an idiot!</strong></span>")
		user.suiciding = 0
		return TRUE
...
/obj/item/paper/book/materials
	...
	/*
	info = {"
	<BIG><strong>Materials</strong></BIG>
	<br>
	...
	<br>
	<br>
	<br><strong>General information:</strong>
	<br>
	...
	<br>
	<br>
	<br><strong>Material properties:</strong>
	<br>
	<br><strong>Siemens coefficient:</strong>
	<br>How well a material conducts electricity.
	<br>Values range from 0 = Non-conductive to 1 = Perfectly conductive.
	<br>
	<br>
	<br><strong>Heat transfer coefficient:</strong>
...
/obj/item/paper/book/mechanicbook
	...
	info = {"
	<BIG><strong>Quick-start Guide</strong></BIG>
	<br>
	...
	<br><em>Wrench a Button Component into Place.</em>
	<br><em>Wrench a Graviton Accelerator into Place.</em>
	<br><em>Drag the Button onto the Accelerator and drop.</em>
	<br><em>Set the Button as Trigger.</em>
	<br><em>Select the only existing target input on the Accelerator.</em>
	<br>
	...
	<br>
	<br>
	<br><strong>E-Gun Component:</strong>
	<br>Shoots a Gun in the given Direction.
	<br>Needs to have a Gun installed before it can be used. Simply use the Gun on the Component.
	...
	<br>
	<br>
	<br><strong>RegEx Replace Component:</strong>
	...
	<br>
	<br>
	<br><strong>Relay Component:</strong>
	...
	<br>
	<br>
	<br><strong>Selection Component:</strong>
	...
	<br>
	<br>
	<br><strong>Signal Builder Component:</strong>
	...
	<br>
	<br>
	<br><strong>Signal Check Component:</strong>
	...
	<br>
	<br>
	<br><strong>Toggle Component:</strong>
	...
	<br>
	<br>
	<br><strong>Wifi Component:</strong>
	...
	<br>
	<br>
	<br><strong>Wifi Signal Splitter Component:</strong>
...
/obj/item/paper/book/cookbook
	...
	<p><em>Disclaimer: At the time of writing, all information in this book is correct. However, over time, the information may become out of date.</em></p>
	<p><em>It is also important to remember that every oven works differently and the cooking times for these recipes might not be optimal.</em></p>
	<hr>
...
/obj/item/paper/book/monster_manual
	...
	<hr>
	<strong>Greysuit</strong>, armored
	<br>
...
<p><em>Disclaimer: At the time of writing, all information in this book is correct. However, over time, the information may become out of date.<br>
Point your browser to <a href=http://wiki.ss13.co/TermOS>http://wiki.ss13.co/TermOS</a> if anything seems amiss.</em>
<h2>Introduction</h2>
...
<p>This book will show commands you should enter as beginning with <em>">"</em>.
<div class="tips">
<li> Remember! The most important command is <em>"help"!</em>
</div>
<br><br>
...
<div class="tips">
<li> When logged in, you can log off by typing <em>"logout" OR "logoff"</em>.
<li> You can disconnect by typing <em>"disconnect"</em>.
<li> You can restart by typing <em>"restart"</em>.
</div>
...
as <em>"/"</em>. So, if we expand this path, we get this:
<div class="code"><pre>/
	home/
		GMelons/
			Pictures/
...
You can also give <em>ls</em> a directory path to look at instead: so if you wanted to snoop on JGrife's stuff, you would type:
<div class="code">
>ls /home/JGrife
</div>
<div class="tips">
...
<li> Programs on a Research Station are usually kept in <em>/mnt/control</em> - the location of the control database.</div>
<p>
What a shocker, eh?
<br>
...
right?<br>
Well, there's a little thing called <em>"output redirection"</em>. This means we can take
...
<li> Type <em>"help rm"</em> for advanced help on deleting files.</div>
<br><br>
...
appear in the <em>/mnt</em> folder in DWAINE.
<br>
...
<p>
To see hidden files, you must use <em>"-l"</em> (not -1) when giving the ls command:
<div class="code">
>ls -l /path
</div>
<p>
...
<p>
Will elevate your priveleges to administrator level. This will let you use the <em>ls</em> command in the root directory to view hidden system files and folders.<br>
...
Unfortunately, the <em>su</em> command requires an administrator-level ID card. But this should not prove a challenge to a fellow agent.<br>
<br>
...
<h2>Tasks</h2>
<ul>
<li><strong>GUARD:</strong> This will direct the Robuddy to serve as a trusty bodyguard, exacting buddy-vengence on anyone attempting to harm their charge.</li>
<li><strong>SYNC:</strong> The sync task is employed when the Robuddy has been instructed to connect to a charge dock.  It directs the unit through radio identification of a free dock and then guides it there.</li>
<li><strong>SECURE:</strong> In this mode, the Robuddy will remain stationary and scan its surrounding environment for hostile agents, based on the same criteria as the "Securitron" series.</li>
<li><strong>PATROL:</strong> Identical to the Secure task, with one exception: The Robuddy will patrol a set path based on navigational radio beacons.</li>
</ul>
...
<p><strong>Checking a Robuddy's Status:</strong><br>
...
<p><strong>Bodyguarding:</strong><br>
...
<p><strong>Waking and Recalling Robuddies:</strong><br>
...
<p><strong>Spaceborne Fungus</strong> (<em>metafungi</em>)</p>
...
<p><strong>Space Grass</strong> (<em>metagraminoidae</em>)</p>
...
<p><strong>Lasher Brambles</strong> (<em>metasalsola lividium</em>)</p>
...
<p><strong>Creeper Vine</strong> (<em>metahedera pervasis</em>)</p>
...
<p><strong>Radiator Weed</strong> (<em>xenocuries nauseus</em>)</p>
...
<p><strong>Toxic Slurry Pod</strong> (<em>xenobulba putrescens</em>)</p>
...
<p><strong>Fast Metabolism</strong>: This strain accelerates a plant's growth, but causes it to drain reagents from its environment more quickly.</p>
<p><strong>Slow Metabolism</strong>: This strain causes a plant to grow more slowly but also use less reagents.</p>
<p><strong>Toxin Immunity</strong>: Any kind of toxin or poison will not harm a plant carrying this strain.</p>
<p><strong>Drought Resistance</strong>: When no water is available, plants with this strain will deteriorate a lot slower.</p>
<p><strong>Enhanced Yield</strong>: Harvests from plants with this strain will be much more bountiful.</p>
<p><strong>Stunted Yield</strong>: The harvest yield from plants with this strain will be poor.</p>
<p><strong>Immortal</strong>: A highly desirable strain that ensures a fruiting plant will never die from being harvested.</p>
<p><strong>Unstable</strong>: Plants carrying this strain will continually mutate by themselves.</p>
<p><strong>Rapid Growth</strong>: A very desirable strain that causes the plant to grow far faster than usual.</p>
<p><strong>Stunted Growth</strong>: This strain will cause the plant to grow much more slowly.</p>
<p><strong>Poor Health</strong>: The condition of plants carrying this strain will deteriorate over time.</p>
<p><strong>Seedless</strong>: A very negative strain that prevents the host plant from reproducing at all.</p>
</body>
</html>
...
/obj/item/paper/book/medical_guide
	...
	info = {"<h1>NT MEDICAL DIVISION</h1>
		...
		<br>
		<hr>
		<em>This is not a complete list of all available medications. Further research and development efforts by NT Medical and Science divisions are strongly encouraged.</em>
		"}
	...
	info = {"
			...
			<body>
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Maintenance shafts</span>
				</p>
				...
				<span class="location"><strong>Location:</strong> Pool</span>
				</p>
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Artificially created by science or anomalous energies</span>
				</p>
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> SS13 Owlery</span>
				</p>
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Deep space</span>
				</p>
				...
				<p>
					...
					<span class="subtitle"><strong>Location:</strong> Absolutely everywhere</span>
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Domestic space-bee eggs, kept as pets throughout all of space
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> SS13 Pool</span>
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Unknown</span>
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Lava moon</span>
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> A russian ship in deep space</span>
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> His ship, out in space</span>
				</p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Created by a chemical reaction</span>
				<p>
				<p class="description">
				...
				<p>
					...
					<span class="location"><strong>Location:</strong> Purportedly, a giant beehive in space.</span>
				</p>
				<p class="description">
