...
/obj/storage/closet/emergency
	...
	desc = "It's a closet! This one can be opened AND closed. Comes prestocked with emergency equipment. <em>Hopefully</em>."
...
/obj/storage/closet/fire
	...
	desc = "It's a closet! This one can be opened AND closed. Comes prestocked with firefighting equipment. <em>Hopefully</em>."
	icon_state = "fire"
	icon_closed = "fire"
